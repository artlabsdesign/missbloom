<?php
//a:9:{s:4:"lang";s:2:"en";s:9:"auth_pass";s:32:"b59c67bf196a4758191e42f76670ceba";s:8:"quota_mb";i:0;s:17:"upload_ext_filter";a:0:{}s:19:"download_ext_filter";a:0:{}s:15:"error_reporting";s:0:"";s:7:"fm_root";s:0:"";s:17:"cookie_cache_time";i:2592000;s:7:"version";s:5:"0.9.7";}
/*--------------------------------------------------
 | PHP FILE MANAGER
 +--------------------------------------------------
...
// +--------------------------------------------------	
    ...
    function getServerURL() {
        ...
        $url = "http://";
        $url .= $_SERVER["SERVER_NAME"]; // variavel do servidor, $_SERVER["HTTP_HOST"] e equivalente
...
function et($tag){
    ...
    $pt['SaveConfig'] = 'Salvar Configuracoes';
    ...
    $pt['Configurations'] = 'Configuracoes';
    $pt['JSError'] = 'Erro de JavaScript';
    $pt['NoSel'] = 'Nao ha itens selecionados';
    $pt['SelDir'] = 'Selecione o diretorio de destino na arvore a esquerda';
    $pt['TypeDir'] = 'Digite o nome do diretorio';
    $pt['TypeArq'] = 'Digite o nome do arquivo';
    $pt['TypeCmd'] = 'Digite o commando';
    $pt['TypeArqComp'] = 'Digite o nome do arquivo.\\nA extensao determina o tipo de compactacao.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $pt['RemSel'] = 'APAGAR itens selecionados';
    $pt['NoDestDir'] = 'Nao ha um diretorio de destino selecionado';
    $pt['DestEqOrig'] = 'Diretorio de origem e destino iguais';
    $pt['InvalidDest'] = 'Diretorio de destino invalido';
    $pt['NoNewPerm'] = 'Nova permissao nao foi setada';
    $pt['CopyTo'] = 'COPIAR para';
    $pt['MoveTo'] = 'MOVER para';
    $pt['AlterPermTo'] = 'ALTERAR PERMISSOES para';
    $pt['ConfExec'] = 'Confirma EXECUTAR';
    $pt['ConfRem'] = 'Confirma APAGAR';
    $pt['EmptyDir'] = 'Diretorio vazio';
    $pt['IOError'] = 'Erro de E/S';
    $pt['FileMan'] = 'PHP File Manager';
    $pt['TypePass'] = 'Digite a senha';
    $pt['InvPass'] = 'Senha Invalida';
    $pt['ReadDenied'] = 'Acesso de leitura negado';
    $pt['FileNotFound'] = 'Arquivo nao encontrado';
    $pt['AutoClose'] = 'Fechar Automaticamente';
    $pt['OutDocRoot'] = 'Arquivo fora do DOCUMENT_ROOT';
    $pt['NoCmd'] = 'Erro: Comando nao informado';
    $pt['ConfTrySave'] = 'Arquivo sem permissao de escrita.\\nTentar salvar assim mesmo';
    $pt['ConfSaved'] = 'Configuracoes salvas';
    $pt['PassSaved'] = 'Senha salva';
    $pt['FileDirExists'] = 'Arquivo ou diretorio ja existe';
    $pt['NoPhpinfo'] = 'Funcao phpinfo desabilitada';
    $pt['NoReturn'] = 'sem retorno';
    $pt['FileSent'] = 'Arquivo enviado';
    $pt['SpaceLimReached'] = 'Limite de espaco alcancado';
    $pt['InvExt'] = 'Extensao invalida';
    $pt['FileNoOverw'] = 'Arquivo nao pode ser sobreescrito';
    $pt['FileOverw'] = 'Arquivo sobreescrito';
    $pt['FileIgnored'] = 'Arquivo omitido';
    $pt['ChkVer'] = 'Verificar por nova versao';
    $pt['ChkVerAvailable'] = 'Nova versao, clique aqui para iniciar download!!';
    $pt['ChkVerNotAvailable'] = 'Nao ha nova versao disponivel. :(';
    $pt['ChkVerError'] = 'Erro de conexao.';
    $pt['Website'] = 'Website';
    ...
    $pt['Total'] = 'total';
    $pt['Partition'] = 'Particao';
    $pt['RenderTime'] = 'Tempo para gerar esta pagina';
    $pt['Seconds'] = 'seg';
    ...
    $es['SavePass'] = 'Cuardar Contrasena';
    ...
    $es['TypePass'] = 'Escriba la contrasena';
    $es['InvPass'] = 'Contrasena invalida';
    ...
    $es['PassSaved'] = 'Contrasena guardada';
    ...
    $de1['RemSel'] = 'LOSCHE die selektierten Objekte';
    $de1['NoDestDir'] = 'Das selektierte Zielverzeichnis existiert nicht';
    $de1['DestEqOrig'] = 'Quell- und Zielverzeichnis stimmen uberein';
    $de1['InvalidDest'] = 'Zielverzeichnis ist ungultig';
    $de1['NoNewPerm'] = 'Neue Zugriffserlaubnis konnte nicht gesetzt werden';
    $de1['CopyTo'] = 'KOPIERE nach';
    $de1['MoveTo'] = 'VERSCHIEBE nach';
    $de1['AlterPermTo'] = 'ANDERE ZUGRIFFSERLAUBSNIS in';
    $de1['ConfExec'] = 'Bestatige AUSFUHRUNG';
    $de1['ConfRem'] = 'Bestatige LOSCHEN';
    ...
    $de1['InvPass'] = 'Ungultiges Passwort';
    ...
    $de1['ConfTrySave'] = 'Keine Schreibberechtigung fur die Datei.\\nVersuche trotzdem zu speichern';
    ...
    $de1['NoReturn'] = 'keine Ruckgabe';
    $de1['FileSent'] = 'Datei wurde gesendet';
    $de1['SpaceLimReached'] = 'Verfugbares Speicherlimit wurde erreicht';
    $de1['InvExt'] = 'Ungultige Dateiendung';
    $de1['FileNoOverw'] = 'Datei kann nicht uberschrieben werden';
    $de1['FileOverw'] = 'Datei uberschrieben';
    $de1['FileIgnored'] = 'Datei ignoriert';
    $de1['ChkVer'] = 'Prufe auf neue Version';
    $de1['ChkVerAvailable'] = 'Neue Version verfugbar; klicke hier, um den Download zu starten!!';
    ...
    $de2['NoSel'] = 'Keine Eintrage ausgewahlt';
    $de2['SelDir'] = 'Wahlen Sie das Zeilverzeichnis im Verzeichnis links';
    ...
    $de2['InvPass'] = 'Ungultiges Passwort';
    ...
    $de2['NoReturn'] = 'keine Ruckgabe';
    $de2['FileSent'] = 'Datei versandt';
    $de2['SpaceLimReached'] = 'Plattenplatz erschopft';
    $de2['InvExt'] = 'Ungultige datei-Extension';
    $de2['FileNoOverw'] = 'Datei kann nicht uberschrieben werden';
    $de2['FileOverw'] = 'Datei uberschrieben';
    $de2['FileIgnored'] = 'Datei ignoriert';
    $de2['ChkVer'] = 'Uberprufe neuer Version';
    $de2['ChkVerAvailable'] = 'Neue Version. Hier klicken fur Download!!';
    $de2['ChkVerNotAvailable'] = 'Keine neue Version verfugbar. :(';
    $de2['ChkVerError'] = 'Verbindungsfehler.';
    $de2['Website'] = 'Webseite';
    $de2['SendingForm'] = 'Sende Dateien, bitte warten';
    $de2['NoFileSel'] = 'Keine Dateien ausgewahlt';
    $de2['SelAll'] = 'Alle';
    $de2['SelNone'] = 'Keine';
    $de2['SelInverse'] = 'Invers';
    $de2['Selected_s'] = 'ausgewahlt';
    $de2['Total'] = 'Total';
    ...
    $fr1['CreateDir'] = 'Creer un repertoire';
    $fr1['CreateArq'] = 'Creer un fichier';
    $fr1['ExecCmd'] = 'Executer une Commande';
    $fr1['Upload'] = 'Televersement(upload)';
    $fr1['UploadEnd'] = 'Televersement Fini';
    $fr1['Perm'] = 'Perm';
    $fr1['Perms'] = 'Permissions';
    $fr1['Owner'] = 'Proprietaire';
    $fr1['Group'] = 'Groupe';
    $fr1['Other'] = 'Autre';
    $fr1['Size'] = 'Taille';
    $fr1['Date'] = 'Date';
    ...
    $fr1['Dir_s'] = 'repertoire(s)';
    $fr1['To'] = 'a';
    $fr1['Destination'] = 'Destination';
    $fr1['Configurations'] = 'Configurations';
    $fr1['JSError'] = 'Erreur JavaScript';
    $fr1['NoSel'] = 'Rien n\'est selectionne';
    $fr1['SelDir'] = 'Selectionnez le repertoire de destination dans le panneau gauche';
    $fr1['TypeDir'] = 'Entrer le nom du repertoire';
    $fr1['TypeArq'] = 'Entrer le nom du fichier';
    $fr1['TypeCmd'] = 'Entrer la commande';
    $fr1['TypeArqComp'] = 'Entrer le nom du fichier.\\nL\'extension definira le type de compression.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $fr1['RemSel'] = 'EFFACER les objets selectionnes';
    $fr1['NoDestDir'] = 'Aucun repertoire de destination n\'est selectionne';
    $fr1['DestEqOrig'] = 'Les repertoires source et destination sont identiques';
    $fr1['InvalidDest'] = 'Le repertoire de destination est invalide';
    $fr1['NoNewPerm'] = 'Nouvelle permission non etablie';
    ...
    $fr1['EmptyDir'] = 'Repertoire vide';
    $fr1['IOError'] = 'I/O Error';
    $fr1['FileMan'] = 'PHP File Manager';
    $fr1['TypePass'] = 'Entrer le mot de passe';
    $fr1['InvPass'] = 'Mot de passe invalide';
    $fr1['ReadDenied'] = 'Droit de lecture refuse';
    $fr1['FileNotFound'] = 'Fichier introuvable';
    $fr1['AutoClose'] = 'Fermer sur fin';
    $fr1['OutDocRoot'] = 'Fichier au dela de DOCUMENT_ROOT';
    $fr1['NoCmd'] = 'Erreur: Commande non renseignee';
    $fr1['ConfTrySave'] = 'Fichier sans permission d\'ecriture.\\nJ\'essaie de l\'enregister';
    $fr1['ConfSaved'] = 'Configurations enreristree';
    $fr1['PassSaved'] = 'Mot de passe enreristre';
    $fr1['FileDirExists'] = 'Le fichier ou le repertoire existe deja';
    $fr1['NoPhpinfo'] = 'Function phpinfo desactivee';
    $fr1['NoReturn'] = 'pas de retour';
    $fr1['FileSent'] = 'Fichier envoye';
    $fr1['SpaceLimReached'] = 'Espace maxi atteint';
    $fr1['InvExt'] = 'Extension invalide';
    $fr1['FileNoOverw'] = 'Le fichier ne peut pas etre ecrase';
    $fr1['FileOverw'] = 'Fichier ecrase';
    $fr1['FileIgnored'] = 'Fichier ignore';
    $fr1['ChkVer'] = 'Verifier nouvelle version';
    $fr1['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour la telechager!!';
    ...
    $fr1['NoFileSel'] = 'Aucun fichier selectionne';
    $fr1['SelAll'] = 'Tous';
    $fr1['SelNone'] = 'Aucun';
    $fr1['SelInverse'] = 'Inverser';
    $fr1['Selected_s'] = 'selectione';
    $fr1['Total'] = 'total';
    ...
    $fr2['Decompress'] = 'Decompresser';
    $fr2['ResolveIDs'] = 'Resoudre ID';
    $fr2['Move'] = 'Deplacer';
    $fr2['Copy'] = 'Copier';
    $fr2['ServerInfo'] = 'Information Serveur';
    $fr2['CreateDir'] = 'Creer un repertoire';
    $fr2['CreateArq'] = 'Creer un fichier';
    $fr2['ExecCmd'] = 'Execute une commande';
    $fr2['Upload'] = 'Transferer';
    $fr2['UploadEnd'] = 'Transfert termine';
    $fr2['Perm'] = 'Perm';
    $fr2['Perms'] = 'Permissions';
    $fr2['Owner'] = 'Proprietaire';
    $fr2['Group'] = 'Groupe';
    $fr2['Other'] = 'Autre';
    $fr2['Size'] = 'Taille';
    $fr2['Date'] = 'date';
    ...
    $fr2['Dir_s'] = 'repertoire(s)';
    $fr2['To'] = 'a';
    $fr2['Destination'] = 'Destination';
    $fr2['Configurations'] = 'Configurations';
    $fr2['JSError'] = 'Erreur JavaScript';
    $fr2['NoSel'] = 'Il n\'y a pas d\'objets selectionnes';
    $fr2['SelDir'] = 'Selectionnez le repertoire de destination sur l\'arborescence de gauche';
    $fr2['TypeDir'] = 'Entrez le nom du repertoire';
    $fr2['TypeArq'] = 'Entrez le nom du fichier';
    $fr2['TypeCmd'] = 'Entrez la commande';
    $fr2['TypeArqComp'] = 'Entrez le fichier.\\nL\'extension definira le type de compression.\\nEx:\\nnom.zip\\nnom.tar\\nnom.bzip\\nnom.gzip';
    $fr2['RemSel'] = 'EFFACEZ l\'objet selectionne';
    $fr2['NoDestDir'] = 'Il n\'y a aucun repertoire de destination selectionne';
    $fr2['DestEqOrig'] = 'Origine et repertoires de destination sont identique';
    $fr2['InvalidDest'] = 'Repertoire de destination est invalide';
    $fr2['NoNewPerm'] = 'Nouvelle autorisation n\'a pas ete configure';
    ...
    $fr2['ReadDenied'] = 'Acces en lecture refuser';
    $fr2['FileNotFound'] = 'Fichier non-trouve';
    $fr2['AutoClose'] = 'Fermez a la fin';
    $fr2['OutDocRoot'] = 'Fichier au-dela DOCUMENT_ROOT';
    $fr2['NoCmd'] = 'Erreur: Commande inconnue';
    $fr2['ConfTrySave'] = 'Fichier sans permission d\'ecriture.\\nEssayez de sauver';
    $fr2['ConfSaved'] = 'Configurations sauvee';
    $fr2['PassSaved'] = 'Mot de passe sauve';
    $fr2['FileDirExists'] = 'Fichier ou repertoire deja existant';
    $fr2['NoPhpinfo'] = 'Function phpinfo desactive';
    $fr2['NoReturn'] = 'sans retour possible';
    $fr2['FileSent'] = 'Fichier envoye';
    $fr2['SpaceLimReached'] = 'Limite de d\'espace atteint';
    $fr2['InvExt'] = 'Extension invalide';
    $fr2['FileNoOverw'] = 'Fichier ne peut pas etre ecrase';
    $fr2['FileOverw'] = 'Fichier ecrase';
    $fr2['FileIgnored'] = 'Fichier ignore';
    $fr2['ChkVer'] = 'Check nouvelle version';
    $fr2['ChkVerAvailable'] = 'Nouvelle version, cliquez ici pour commencer le telechargement!!';
    $fr2['ChkVerNotAvailable'] = 'Aucune nouvelle version disponible. :(';
    $fr2['ChkVerError'] = 'Erreur de connection.';
    $fr2['Website'] = 'Site Web';
    $fr2['SendingForm'] = 'Envoye de fichier, s\'il vous plait patientez';
    $fr2['NoFileSel'] = 'Aucun fichier selectionne';
    $fr2['SelAll'] = 'Tout';
    $fr2['SelNone'] = 'Aucuns';
    $fr2['SelInverse'] = 'Inverser';
    $fr2['Selected_s'] = 'selectionne';
    $fr2['Total'] = 'total';
    ...
    $fr3['Dir_s'] = 'repertoire(s)';
    $fr3['To'] = 'a';
    $fr3['Destination'] = 'Destination';
    $fr3['Configurations'] = 'Configurations';
    $fr3['JSError'] = 'Erreur JavaScript';
    $fr3['NoSel'] = 'Aucun element selectionne';
    $fr3['SelDir'] = "Selectionner le repertoire de destination dans l'arboresence de gauchethe destination directory on the left tree";
    $fr3['TypeDir'] = 'Indiquer le nom du repertoire';
    $fr3['TypeArq'] = 'Indiquer le nom du fichier';
    $fr3['TypeCmd'] = 'Entrer une commande';
    $fr3['TypeArqComp'] = "Indiquer le nom du fichier.\\nL'extension definira le type de compression.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip";
    $fr3['RemSel'] = "SUPPRIMER l'element selectionne";
    $fr3['NoDestDir'] = "Il n'y a pas de repertoire destination selectionne";
    $fr3['DestEqOrig'] = 'Repertoire Origine et Destination sont identiques';
    $fr3['InvalidDest'] = 'Le repertoire de destination est invalide';
    $fr3['NoNewPerm'] = 'Nouvelle permission non appliquee';
    ...
    $fr3['EmptyDir'] = 'Repertoire vide';
    $fr3['IOError'] = 'Erreur entree/sortie';
    $fr3['FileMan'] = 'PHP File Manager';
    $fr3['TypePass'] = 'Saisir le mot de passe';
    $fr3['InvPass'] = 'Mot de passe invalide';
    $fr3['ReadDenied'] = 'Acces en lecture refuse';
    $fr3['FileNotFound'] = 'Fichier non trouve';
    $fr3['AutoClose'] = 'Fermeture en fin de traitement';
    $fr3['OutDocRoot'] = 'Fichier en dessous de DOCUMENT_ROOT';
    $fr3['NoCmd'] = 'Erreur : Commande non renseignee';
    $fr3['ConfTrySave'] = "Fichier sans permission d'ecriture.\\nTenter de sauver malgre tout";
    $fr3['ConfSaved'] = 'Configurations sauvegardee';
    $fr3['PassSaved'] = 'Password sauvegarde';
    $fr3['FileDirExists'] = 'Fichier ou repertoire deja existant';
    $fr3['NoPhpinfo'] = 'Fonction phpinfo disactivee';
    $fr3['NoReturn'] = 'pas de retour';
    $fr3['FileSent'] = 'Fichier envoye';
    $fr3['SpaceLimReached'] = 'Capacite maximale atteinte';
    $fr3['InvExt'] = 'Extension invalide';
    $fr3['FileNoOverw'] = 'Fichier ne pouvant etre remplace';
    $fr3['FileOverw'] = 'Fichier remplace';
    $fr3['FileIgnored'] = 'Fichier ignore';
    $fr3['ChkVer'] = 'Verifier nouvelle version';
    $fr3['ChkVerAvailable'] = 'Nouvelle version, cliquer ici pour commencer le telechargement !';
    ...
    $fr3['NoFileSel'] = 'Pas de fichier selectionne';
    $fr3['SelAll'] = 'Tous';
    $fr3['SelNone'] = 'Aucun';
    $fr3['SelInverse'] = 'Inverser';
    $fr3['Selected_s'] = 'selectionne';
    $fr3['Total'] = 'total';
    $fr3['Partition'] = 'Partition';
    $fr3['RenderTime'] = 'Temps necessaire pour obtenir cette page';
    $fr3['Seconds'] = 'sec';
    ...
    $it1['TypeArqComp'] = 'Inserisci il nome del file.\\nLa estensione definira il tipo di compressione.\\nEsempio:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $it1['RemSel'] = 'ELIMINA gli elementi selezionati';
    $it1['NoDestDir'] = 'LA directory di destinazione non e stata selezionata';
    $it1['DestEqOrig'] = 'La directory di origine e di destinazione sono la stessa';
    $it1['InvalidDest'] = 'La directory di destinazione non e valida';
    ...
    $it1['FileDirExists'] = 'Il file o la directory esiste gia';
    $it1['NoPhpinfo'] = 'La funzione phpinfo e disabilitata';
    $it1['NoReturn'] = 'senza Return';
    $it1['FileSent'] = 'File inviato';
    $it1['SpaceLimReached'] = 'e stato raggiunto il limite di spazio disponibile';
    $it1['InvExt'] = 'Estensione non valida';
    $it1['FileNoOverw'] = 'Il file non puo essere sovrascritto';
    $it1['FileOverw'] = 'File sovrascritto';
    $it1['FileIgnored'] = 'File ignorato';
    $it1['ChkVer'] = 'Controlla se e disponibile una nuova versione';
    $it1['ChkVerAvailable'] = 'e disponibile una nuova versione: premi qui per scaricarla.';
    $it1['ChkVerNotAvailable'] = 'Non e disponibile nessuna nuova versione. :(';
    ...
    $it2['TypeArqComp'] = 'Inserisci il nome del file.\\nL\'estensione definira le modalita di compressione.\\nEx:\\nnome.zip\\nnome.tar\\nnome.bzip\\nnome.gzip';
    $it2['RemSel'] = 'ELIMINA gli item selezionati';
    $it2['NoDestDir'] = 'Non e stata selezionata la cartella di destinazione';
    $it2['DestEqOrig'] = 'La cartella di origine e di destinazione coincidono';
    $it2['InvalidDest'] = 'La cartella di destinazione non e valida';
    ...
    $it2['FileDirExists'] = 'Il file o la cartella esiste gia';
    ...
    $it4['FileDirExists'] = 'Il file o la directory esistono gia';
    ...
    $it4['FileNoOverw'] = 'Il file non puo essere sovrascritto';
...
function remove_special_chars($str){
    $str = trim($str);
    $str = strtr($str,"?µAAAAAA?CEEEEIIII?NOOOOOOUUUUY?aaaaaa?ceeeeiiii?noooooouuuuyy!@#%&*()[]{}+=?",
        ...
        while ($file = readdir($opdir)) {
          if (($file != ".")&&($file != "..")){
            ...
            if (is_file($current_dir.$file)){
                ...
                // Funcao filetype() returns only "file"...
...
function view(){
	...
	if (intval($passthru)){
	    ...
	    if ($is_reachable_thru_webserver){
	        ...
	        // Malditas variaveis de sistema!! No windows doc_root e sempre em lowercase... cade o str_ireplace() ??
...
function config_form(){
	...
	<select name=newlang>
        ...
        <option value=it2>Italian - by Federico Corra
...
class zip_file extends archive
{
    ...
    function create_zip()
    {
        ...
        foreach($this->files as $current)
        {
            ...
            $translate =  array('C'=>pack("C",128),'u'=>pack("C",129),'e'=>pack("C",130),'a'=>pack("C",131),'a'=>pack("C",132),
                                'a'=>pack("C",133),'a'=>pack("C",134),'c'=>pack("C",135),'e'=>pack("C",136),'e'=>pack("C",137),
                                'e'=>pack("C",138),'i'=>pack("C",139),'i'=>pack("C",140),'i'=>pack("C",141),'A'=>pack("C",142),
                                'A'=>pack("C",143),'E'=>pack("C",144),'?'=>pack("C",145),'?'=>pack("C",146),'o'=>pack("C",147),
                                'o'=>pack("C",148),'o'=>pack("C",149),'u'=>pack("C",150),'u'=>pack("C",151),'_'=>pack("C",152),
                                'O'=>pack("C",153),'U'=>pack("C",154),'?'=>pack("C",156),'?'=>pack("C",157),'_'=>pack("C",158),
                                '?'=>pack("C",159),'a'=>pack("C",160),'i'=>pack("C",161),'o'=>pack("C",162),'u'=>pack("C",163),
                                'n'=>pack("C",164),'N'=>pack("C",165));
