...
class ControllerSaleOrder extends Controller {
	...
	public function getForm() {
		...
		$this->data['entry_reward'] = $this->language->get('entry_reward');
                $this->data['text_postcard'] = $this->language->get('text_postcard');
                $this->data['text_signature'] = $this->language->get('text_signature');
                $this->data['text_photo_free'] = $this->language->get('text_photo_free');
                $this->data['text_photo_site'] = $this->language->get('text_photo_site');
                $this->data['text_rt'] = $this->language->get('text_rt');
                $this->data['text_rt_name'] = $this->language->get('text_rt_name');
                $this->data['text_rt_telephone'] = $this->language->get('text_rt_telephone');
                $this->data['text_rt_clarify'] = $this->language->get('text_rt_clarify');
                $this->data['text_address_type'] = $this->language->get('text_address_type');
                $this->data['text_street'] = $this->language->get('text_street');
                $this->data['text_house'] = $this->language->get('text_house');
                $this->data['text_building'] = $this->language->get('text_building');
                $this->data['text_office'] = $this->language->get('text_office');
                ...
                $this->data['text_shipping_date'] = $this->language->get('text_shipping_date');
                $this->data['text_shipping_time'] = $this->language->get('text_shipping_time');
                $this->data['text_remind'] = $this->language->get('text_remind');
                $this->data['text_order_status_sms'] = $this->language->get('text_order_status_sms');
                $this->data['text_order_status_email'] = $this->language->get('text_order_status_email');
		...
		} elseif (!empty($order_info) && $order_info['payment_zone_id']) {
		...
		} elseif (!empty($order_info) && $order_info['shipping_zone_id']) {
		...
		if (isset($this->request->post['order_total'])) {
			...
			$this->data['order_totals'] = array();
                ...
                if (isset($this->request->post['postcard'])) {
			$this->data['postcard'] = $this->request->post['postcard'];
		} elseif (!empty($order_info)) {
			$this->data['postcard'] = $order_info['postcard'];
		} else {
			$this->data['postcard'] = '';
		}
			...
			$this->data['signature'] = $order_info['signature'];
		} else {
			$this->data['signature'] = '';
		}
                
                if (isset($this->request->post['photo_free'])) {
			$this->data['photo_free'] = $this->request->post['photo_free'];
		} elseif (!empty($order_info)) {
			$this->data['photo_free'] = $order_info['photo_free'];
		} else {
			$this->data['photo_free'] = '';
		}
                
                if (isset($this->request->post['photo_site'])) {
			$this->data['photo_site'] = $this->request->post['photo_site'];
		} elseif (!empty($order_info)) {
			$this->data['photo_site'] = $order_info['photo_site'];
		} else {
			$this->data['photo_site'] = '';
		}
                
                if (isset($this->request->post['rt'])) {
			$this->data['rt'] = $this->request->post['rt'];
		} elseif (!empty($order_info)) {
			$this->data['rt'] = $order_info['rt'];
		} else {
			$this->data['rt'] = '';
		}
                
                if (isset($this->request->post['rt_name'])) {
			$this->data['rt_name'] = $this->request->post['rt_name'];
		} elseif (!empty($order_info)) {
			$this->data['rt_name'] = $order_info['rt_name'];
		} else {
			$this->data['rt_name'] = '';
		}
                
                if (isset($this->request->post['rt_telephone'])) {
			$this->data['rt_telephone'] = $this->request->post['rt_telephone'];
		} elseif (!empty($order_info)) {
			$this->data['rt_telephone'] = $order_info['rt_telephone'];
		} else {
			$this->data['rt_telephone'] = '';
		}
                
                if (isset($this->request->post['rt_clarify'])) {
			$this->data['rt_clarify'] = $this->request->post['rt_clarify'];
		} elseif (!empty($order_info)) {
			$this->data['rt_clarify'] = $order_info['rt_clarify'];
		} else {
			...
			$this->data['address_type'] = $order_info['address_type'];
		} else {
			...
			$this->data['house'] = $this->request->post['house'];
		} elseif (!empty($order_info)) {
			$this->data['house'] = $order_info['house'];
		} else {
			$this->data['house'] = '';
		}
                
                if (isset($this->request->post['building'])) {
			$this->data['building'] = $this->request->post['building'];
		} elseif (!empty($order_info)) {
			$this->data['building'] = $order_info['building'];
		} else {
			$this->data['building'] = '';
		}
			...
			$this->data['office'] = $order_info['office'];
		} else {
			$this->data['office'] = '';
		}
                
                if (isset($this->request->post['flat'])) {
			$this->data['flat'] = $this->request->post['flat'];
		} elseif (!empty($order_info)) {
			...
			$this->data['room'] = $order_info['room'];
		} else {
			$this->data['room'] = '';
		}
                
                if (isset($this->request->post['ward'])) {
			$this->data['ward'] = $this->request->post['ward'];
		} elseif (!empty($order_info)) {
			$this->data['ward'] = $order_info['ward'];
		} else {
			$this->data['ward'] = '';
		}
			...
			$this->data['shipping_date'] = $order_info['shipping_date'];
		} else {
			...
			$this->data['shipping_time'] = '';
                ...
                if (isset($this->request->post['remind'])) {
			$this->data['remind'] = $this->request->post['remind'];
		} elseif (!empty($order_info)) {
			$this->data['remind'] = $order_info['remind'];
		} else {
			$this->data['remind'] = '';
		}
                
                if (isset($this->request->post['order_status_sms'])) {
			$this->data['order_status_sms'] = $this->request->post['order_status_sms'];
		} elseif (!empty($order_info)) {
			$this->data['order_status_sms'] = $order_info['order_status_sms'];
		} else {
			$this->data['order_status_sms'] = 0;
		}
                
                if (isset($this->request->post['order_status_email'])) {
			$this->data['order_status_email'] = $this->request->post['order_status_email'];
		} elseif (!empty($order_info)) {
			$this->data['order_status_email'] = $order_info['order_status_email'];
		} else {
			$this->data['order_status_email'] = 0;
		}
                
                if (isset($this->request->post['newsletter'])) {
			$this->data['newsletter'] = $this->request->post['newsletter'];
		} elseif (!empty($order_info)) {
			$this->data['newsletter'] = $order_info['newsletter'];
		} else {
		...
		if ($order_info) {
			...
			if($this->hasAction('payment/' . $order_info['payment_code'] . '/orderAction') == true){
				...
				$this->data['payment_action'] = '';
                        ...
                        $this->data['rt_telephone'] = $order_info['rt_telephone'];
                        $this->data['rt_clarify'] = $order_info['rt_clarify'];
                        $this->data['address_type'] = $address_types[$order_info['address_type']];
                        $this->data['street'] = $order_info['street'];
                        $this->data['house'] = $order_info['house'];
                        $this->data['building'] = $order_info['building'];
                        $this->data['office'] = $order_info['office'];
