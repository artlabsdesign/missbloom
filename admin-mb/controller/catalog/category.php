...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['entry_noview'] = $this->language->get('entry_noview');
		...
		if (isset($this->request->post['noview'])) {
			$this->data['noview'] = $this->request->post['noview'];
		} elseif (!empty($category_info)) {
			$this->data['noview'] = $category_info['noview'];
		} else {
			$this->data['noview'] = 0;
		}
