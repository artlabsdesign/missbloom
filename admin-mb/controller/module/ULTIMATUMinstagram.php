...
class ControllerModuleULTIMATUMinstagram extends Controller {
	private $error = array();
	private $_name = 'ULTIMATUMinstagram';
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('ULTIMATUMinstagram', $this->request->post);		
		...
		if (isset($this->request->post['ULTIMATUMinstagram_module'])) {
			$this->data['modules'] = $this->request->post['ULTIMATUMinstagram_module'];
		} elseif ($this->config->get('ULTIMATUMinstagram_module')) { 
			$this->data['modules'] = $this->config->get('ULTIMATUMinstagram_module');
		}
