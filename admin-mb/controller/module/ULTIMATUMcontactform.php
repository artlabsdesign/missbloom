...
class ControllerModuleULTIMATUMcontactform extends Controller {
	private $error = array();
	private $_name = 'ULTIMATUMcontactform';
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting->editSetting('ULTIMATUMcontactform', $this->request->post);		
		...
		if (isset($this->request->post['ULTIMATUMcontactform_module'])) {
			$this->data['modules'] = $this->request->post['ULTIMATUMcontactform_module'];
		} elseif ($this->config->get('ULTIMATUMcontactform_module')) { 
			$this->data['modules'] = $this->config->get('ULTIMATUMcontactform_module');
		}
