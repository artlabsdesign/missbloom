...
class ControllerModuleajaxcheckout extends Controller {

    private $error = array();

    public function index() {

        $this->load->language('module/ajaxcheckout');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('setting/setting');

        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->model_setting_setting->editSetting('ajaxcheckout', $this->request->post);
            $this->session->data['success'] = $this->language->get('text_success');
            $this->redirect($this->url->link('module/ajaxcheckout', 'token=' . $this->session->data['token'], 'SSL'));
        }
        ...
        $this->data['text_ajaxcheckout_yes'] = $this->language->get('text_ajaxcheckout_yes');
        $this->data['text_ajaxcheckout_no'] = $this->language->get('text_ajaxcheckout_no');
        $this->data['text_ajaxcheckout_required'] = $this->language->get('text_ajaxcheckout_required');
        $this->data['text_ajaxcheckout_hideimg'] = $this->language->get('text_ajaxcheckout_hideimg');
        $this->data['text_ajaxcheckout_hidefio'] = $this->language->get('text_ajaxcheckout_hidefio');
        $this->data['text_ajaxcheckout_hideemail'] = $this->language->get('text_ajaxcheckout_hideemail');
        $this->data['text_ajaxcheckout_hidetelephone'] = $this->language->get('text_ajaxcheckout_hidetelephone');
        $this->data['text_ajaxcheckout_hideshipping'] = $this->language->get('text_ajaxcheckout_hideshipping');
        $this->data['text_ajaxcheckout_hidepayment'] = $this->language->get('text_ajaxcheckout_hidepayment');
        $this->data['text_ajaxcheckout_hideoptions'] = $this->language->get('text_ajaxcheckout_hideoptions');
        $this->data['text_ajaxcheckout_hidedescription'] = $this->language->get('text_ajaxcheckout_hidedescription');
        $this->data['text_ajaxcheckout_makeachoice'] = $this->language->get('text_ajaxcheckout_makeachoice');
        ...
        $this->data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('module/ajaxcheckout', 'token=' . $this->session->data['token'], 'SSL'),
            'separator' => ' :: '
        );

        $this->data['action'] = $this->url->link('module/ajaxcheckout', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $this->template = 'module/ajaxcheckout.tpl';
    ...
    private function validate() {
        if (!$this->user->hasPermission('modify', 'module/ajaxcheckout')) {
