          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><span<?php echo ($this->language->get('text_disabled') == $banner['status'])?' class="label label-warning"':' class="label label-primary"'; ?>><?php echo $banner['status']; ?></span></td>
                <td class="text-right"><?php foreach ($banner['action'] as $action) { ?>
                  <a href="<?php echo $action['href']; ?>" data-toggle="tooltip" title="<?php echo $action['text']; ?>" class="btn <?php $text_disabled = $this->language->get('text_disabled'); if ( isset($text_disabled) && $text_disabled == $banner['status'] ){ echo " btn-warning"; }else{ echo " btn-primary"; } ?>"><i class="fa fa-edit"></i> <?php echo $action['text']; ?></a>
                  <?php } ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
