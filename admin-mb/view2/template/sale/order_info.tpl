...
<div id="content" class="container">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right"><a href="<?php echo $invoice; ?>" target="_blank" class="btn btn-info btn-xs"><i class="fa fa-print"></i> <?php echo $button_invoice; ?></a> <a href="<?php echo $cancel; ?>" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> <?php echo $button_cancel; ?></a></div>
    ...
    <div class="panel-body">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane" id="tab-shipping">
          ...
          <?php if (!empty($amazon_order_id) && empty($shipping_lastname)) { ?> 
            ...
            <tr>
              ...
              <td><?php echo ($rt==1)?$shipping_firstname:$rt_name; ?></td>
            </tr>
          ...
          <?php if($shipping_time && $shipping_time != '-'){ ?>
          <tr>
          ...
          <tr>
            ...
            <td><?php echo $photo_free?'<span class="yes">Да</span>':'<span class="no">Нет</span>'; ?></td>
          </tr>
          <tr>
            <td><?php echo $text_photo_site; ?></td>
            <td><?php echo $photo_site?'<span class="yes">Да</span>':'<span class="no">Нет</span>'; ?></td>
          </tr>
          </table>
        </div>
        <?php } ?>
        <div class="tab-pane" id="tab-product">
		 <?php if($postcard) { ?>
          <p><b><?php echo $text_postcard;?></b> <?php echo $postcard; ?></p>
        <?php } ?>
        <?php if($signature) { ?>
          <p><b><?php echo $text_signature;?></b> <?php echo $signature; ?></p>
        <?php } ?>
          <table class="table table-striped table-bordered">
            <thead>
              <tr>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-credit-add').replaceWith('<button id="button-credit-remove" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_credit_remove; ?></button>');
			}
		}
	});
});
...
$(document).delegate('#button-credit-remove', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.panel').before('<div class="alert alert-danger">' + json['error'] + '</div>');
			...
			if (json['success']) {
				...
				$('#button-credit-remove').replaceWith('<button id="button-credit-add" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i> <?php echo $text_credit_add; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-reward-add').replaceWith('<button id="button-reward-remove" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_reward_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-reward-remove').replaceWith('<button id="button-reward-add" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i> <?php echo $text_reward_add; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-commission-add').replaceWith('<button id="button-commission-remove" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_commission_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-commission-remove').replaceWith('<button id="button-commission-add" class="btn btn-success btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_commission_add; ?></button>');
			}
		}
	});
});
