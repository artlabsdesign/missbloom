  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button id="button-send" class="btn btn-primary btn-xs" onclick="send('index.php?route=marketing/contact/send&token=<?php echo $token; ?>');"><i class="fa fa-envelope"></i> <?php echo $button_send; ?></button>
