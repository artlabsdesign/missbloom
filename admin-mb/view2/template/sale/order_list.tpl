  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-order" formaction="<?php echo $invoice; ?>" formtarget="_blank" class="btn btn-info btn-xs"><i class="fa fa-print"></i> <?php echo $button_invoice; ?></button>
        <a href="<?php echo $insert; ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> <?php echo $button_insert; ?></a>
        <div class="btn-group">
...
?>
              ...
              <tr<?php echo ($order['status'] == $complete) ? ' class="success"' : ' class="warning"'; ?>>
