  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-customer" formaction="<?php echo $approve; ?>" class="btn btn-xs btn-success"><i class="fa fa-check"></i> <?php echo $button_approve; ?></button>
        <a href="<?php echo $insert; ?>" class="btn btn-xs btn-primary"><i class="fa fa-plus"></i> <?php echo $button_insert; ?></a>
        <div class="btn-group">
