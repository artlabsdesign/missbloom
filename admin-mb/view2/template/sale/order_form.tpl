  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-order" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-order" class="form-horizontal">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-payment">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-payment-company-id"><?php echo $entry_company_id; ?></label>
              <div class="col-sm-10">
                <input type="text" name="payment_company_id" value="<?php echo $payment_company_id; ?>" id="input-payment-company-id" class="form-control" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-payment-tax-id"><?php echo $entry_tax_id; ?></label>
              <div class="col-sm-10">
                <input type="text" name="payment_tax_id" value="<?php echo $payment_tax_id; ?>" id="input-payment-tax-id" class="form-control" />
		<?php if ($error_payment_tax_id) { ?>
                <div class="text-danger"><?php echo $error_payment_tax_id; ?></div>
                <?php } ?>
              </div>
            </div>
            <div class="form-group required">
          ...
          <div class="tab-pane" id="tab-product">
            ...
            <div class="text-right">
              <button type="button" id="button-product" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_product; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-voucher">
            ...
            <div class="text-right">
              <button type="button" id="button-voucher" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_voucher; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-total">
            ...
            <div class="text-right">
              <button type="button" id="button-update" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_update_total; ?></button>
            </div>
          </div>
        </div>
      </form>
		...
		if (item['option'] != '') {
			...
			for (i = 0; i < item['option'].length; i++) {
				...
				if (option['type'] == 'text') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-sm-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-sm-10"><input type="text" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" id="input-option' + option['product_option_id'] + '" class="form-control" /></div>';
					html += '</div>';					
				}
				...
				if (option['type'] == 'file') {
					...
					html += '  <label class="col-sm-2 control-label">' + option['name'] + '</label>';
					html += '  <div class="col-sm-10">';
					html += '    <button type="button" id="button-option' + option['product_option_id'] + '" class="btn btn-info" onclick="upload(\'' + option['product_option_id'] + '\');"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>';
...
function upload(product_option_id) {
	...
	$('#file').on('change', function() {
		$.ajax({
			...
			processData: false,				
			beforeSend: function() {
				$('#button-option' + product_option_id).after(' <i class="fa fa-spinner fa-spin"></i>');
