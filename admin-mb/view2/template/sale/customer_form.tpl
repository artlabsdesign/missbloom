  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-customer" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
        ...
        <div class="tab-content">
  		...
  		<label class="btn btn-primary<?php if ($newsletter == 1) { ?> active<?php } ?>">
  			...
  			<label class="btn btn-primary<?php if ($newsletter == 0) { ?> active<?php } ?>">
          ...
          <div class="tab-pane" id="tab-transaction">
            ...
            <div class="text-right">
              <button type="button" id="button-transaction" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_transaction; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-reward">
            ...
            <div class="text-right">
              <button type="button" id="button-reward" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_reward; ?></button>
            </div>
          </div>
          <?php } ?>
