...
<div id="content" class="container">
  <ul class="breadcrumb">
    ...
    <?php } ?>
    <?php if ($error) { ?>
    <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error; ?>    <button type="button" class="close" data-dismiss="alert">&times;</button>
    <?php } ?>
...
<div class="panel panel-default">
    <div class="panel-heading">
      <h1 class="panel-title"><i class="fa fa-list"></i> <a href="http://www.openbaypro.com" target="_BLANK"><img src="https://uk.openbaypro.com/asset/OpenBayPro_30px_h.png" alt="OpenBay Pro" style="margin-top:5px; margin-left:5px; border: 0px;;" border="0" /></a></h1>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td class="right"><div class="btn-group"><?php foreach ($extension['action'] as $action) { ?>
