    ...
    <div class="panel-body">
      <form class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <button type="button" id="button-upload" class="btn btn-primary" onclick="$('input[name=\'file\']').val(''); $('input[name=\'file\']').click();"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
            <?php if ($error_warning) { ?>
