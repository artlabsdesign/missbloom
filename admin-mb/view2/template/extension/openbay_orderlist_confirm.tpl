  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
            <a href="<?php echo $link_cancel; ?>" class="btn btn-primary btn-xs"><?php echo $lang_cancel; ?></a>
      </div>
      <h1 class="panel-title"><i class="fa fa-list"></i> <?php echo $lang_confirm_title; ?></h1>
    </div>
    <div class="panel-body">
        <div class="alert alert-warning"><?php echo $lang_confirm_change_text; ?>: <strong><?php echo $status_mapped[$this->request->post['change_order_status_id']]; ?></strong></div>
...
?>
        ...
        <div class="buttons right" style="margin-top:20px;">
            <a onclick="validate();" class="btn btn-primary"><?php echo $lang_update; ?></a>
        </div>
    </div>
  </div>
</div>
