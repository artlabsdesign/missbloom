  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-klarna-invoice" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-klarna-invoice" class="form-horizontal">
		...
		<div class="btn-group" data-toggle="buttons">
  			...
  			<label class="btn btn-primary<?php if (isset($klarna_invoice[$country['code']]) && $klarna_invoice[$country['code']]['status'] == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="klarna_invoice[<?php echo $country['code']; ?>][status]" id="input-status<?php echo $country['code']; ?>" value="1" <?php if (isset($klarna_invoice[$country['code']]) && $klarna_invoice[$country['code']]['status'] == 1) { ?>checked="checked"<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if (isset($klarna_invoice[$country['code']]) && $klarna_invoice[$country['code']]['status'] == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="klarna_invoice[<?php echo $country['code']; ?>][status]" id="input-status<?php echo $country['code']; ?>" value="0" <?php if (isset($klarna_invoice[$country['code']]) && $klarna_invoice[$country['code']]['status'] == 0) { ?>checked="checked"<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
