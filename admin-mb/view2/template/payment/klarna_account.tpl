  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-klarna-account" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-klarna-account" class="form-horizontal">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-<?php echo $country['code']; ?>">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="klarna_account[<?php echo $country['code']; ?>][merchant]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['merchant'] : ''; ?>" id="input-merchant<?php echo $country['code']; ?>" class="form-control" />
		 </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-secret<?php echo $country['code']; ?>"><?php echo $entry_secret; ?></label>
                  <div class="col-sm-10">
                    <input type="text" name="klarna_account[<?php echo $country['code']; ?>][secret]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['secret'] : ''; ?>" id="input-secret<?php echo $country['code']; ?>" class="form-control" />
		</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="klarna_account[<?php echo $country['code']; ?>][total]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['total'] : ''; ?>" id="input-total<?php echo $country['code']; ?>" class="form-control" />
			</div>
                </div>
                <div class="form-group">
		...
		<div class="btn-group" data-toggle="buttons">
  			...
  			<label class="btn btn-primary<?php if (isset($klarna_account[$country['code']]) && $klarna_account[$country['code']]['status'] == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="klarna_account[<?php echo $country['code']; ?>][status]" id="input-status<?php echo $country['code']; ?>" value="1" <?php if (isset($klarna_account[$country['code']]) && $klarna_account[$country['code']]['status'] == 1) { ?>checked="checked"<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if (isset($klarna_account[$country['code']]) && $klarna_account[$country['code']]['status'] == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" nname="klarna_account[<?php echo $country['code']; ?>][status]" id="input-status<?php echo $country['code']; ?>" value="0" <?php if (isset($klarna_account[$country['code']]) && $klarna_account[$country['code']]['status'] == 0) { ?>checked="checked"<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="klarna_account[<?php echo $country['code']; ?>][sort_order]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['sort_order'] : ''; ?>" id="input-sort-order<?php echo $country['code']; ?>" class="form-control" />
                  </div>
                </div>
              </div>
              <?php } ?>
