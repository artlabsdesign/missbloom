    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-authorizenet-aim" class="form-horizontal">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_aim_login" value="<?php echo $authorizenet_aim_login; ?>" id="input-login" class="form-control" />
            <?php if ($error_login) { ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_aim_key" value="<?php echo $authorizenet_aim_key; ?>" id="input-key" class="form-control" />
            <?php if ($error_key) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_aim_hash" value="<?php echo $authorizenet_aim_hash; ?>" id="input-hash" class="form-control" />
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_aim_total" value="<?php echo $authorizenet_aim_total; ?>" id="input-total" class="form-control" />
	</div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
  			...
  			<label class="btn btn-primary<?php if ($authorizenet_aim_status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="authorizenet_aim_status" id="input-status" <?php if ($authorizenet_aim_status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($authorizenet_aim_status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="authorizenet_aim_status" id="input-status" <?php if ($authorizenet_aim_status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_aim_sort_order" value="<?php echo $authorizenet_aim_sort_order; ?>" id="input-sort-order" class="form-control" />
          </div>
        </div>
      </form>
    </div>
