...
<div id="content" class="container">
  ...
  <div class="panel-body">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_vendor"><?php echo $entry_vendor; ?></label>
		<div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_user"><?php echo $entry_user; ?></label>
		<div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_password"><?php echo $entry_password; ?></label>
		<div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_partner"><?php echo $entry_partner; ?></label>
		<div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_transaction_method"><?php echo $entry_transaction_method; ?></label>
		<div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_test"><?php echo $entry_test; ?></label>
		<div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_debug"><?php echo $entry_debug; ?></label>
		<div class="col-sm-10">
		<div class="btn-group" data-toggle="buttons">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_checkout_method"><?php echo $entry_checkout_method ?></label>
		<div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_order_status_id"><?php echo $entry_order_status; ?></label>
                    <div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_total"><?php echo $entry_total; ?></label>
                    <div class="col-sm-10">
                    <input type="text" name="pp_payflow_iframe_total" value="<?php echo $pp_payflow_iframe_total; ?>" class="form-control"/>
                </div>
          </div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_geo_zone_id"><?php echo $entry_geo_zone; ?></label>
                    <div class="col-sm-10">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_status"><?php echo $entry_status; ?></label>
                    <div class="col-sm-10">
		<div class="btn-group" data-toggle="buttons">
        ...
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_payflow_iframe_sort_order"><?php echo $entry_sort_order; ?></label>
                    <div class="col-sm-10">
			<input type="text" name="pp_payflow_iframe_sort_order" value="<?php echo $pp_payflow_iframe_sort_order; ?>" class="form-control"/>
                </div>
                </div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="cancel_url"><?php echo $entry_cancel_url; ?></label>
                    <div class="col-sm-10">
			<input type="text" name="cancel_url" value="<?php echo $cancel_url ?>" class="form-control"/>
		</div>
	</div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="error_url"><?php echo $entry_error_url; ?></label>
                    <div class="col-sm-10">
			<input type="text" name="error_url" value="<?php echo $error_url; ?>" class="form-control"/>
		</div>
	</div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="return_url"><?php echo $entry_return_url; ?></label>
                    <div class="col-sm-10">
			<input type="text" name="return_url" value="<?php echo $return_url ?>" class="form-control"/>
		</div>
	</div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="post_url"><?php echo $entry_post_url; ?></label>
                    <div class="col-sm-10">
