  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-twocheckout" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-twocheckout" class="form-horizontal">
		...
		<div class="btn-group" data-toggle="buttons">
  			...
  			<label class="btn btn-primary<?php if ($twocheckout_test == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="twocheckout_test" value="1" <?php if ($twocheckout_test == 1) { ?>checked="checked"<?php } ?>> <?php echo $text_yes; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($twocheckout_test == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="twocheckout_test" value="0" <?php if ($twocheckout_test == 0) { ?>checked="checked"<?php } ?>> <?php echo $text_no; ?>
  			</label>
		</div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
                <div class="btn-group" data-toggle="buttons">
  		<label class="btn btn-primary<?php if ($twocheckout_status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="twocheckout_status" id="input-status" <?php if ($twocheckout_status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($twocheckout_status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="twocheckout_status" id="input-status" <?php if ($twocheckout_status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
          </div>
        </div>
