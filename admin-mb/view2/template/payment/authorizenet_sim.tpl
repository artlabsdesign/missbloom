  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-authorizenet-sim" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-authorizenet-sim" class="form-horizontal">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_merchant" value="<?php echo $authorizenet_merchant; ?>" id="input-merchant" class="form-control" />
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_key" value="<?php echo $authorizenet_key; ?>" id="input-key" class="form-control" />
            <?php if ($error_key) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_total" value="<?php echo $authorizenet_total; ?>" id="input-total" class="form-control" />
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
  			...
  			<label class="btn btn-primary<?php if ($authorizenet_status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="authorizenet_status" id="input-status" <?php if ($authorizenet_status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($authorizenet_status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="authorizenet_status" id="input-status" <?php if ($authorizenet_status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="authorizenet_sort_order" value="<?php echo $authorizenet_sort_order; ?>" id="input-sort-order" class="form-control" />
          </div>
        </div>
      </form>
    </div>
