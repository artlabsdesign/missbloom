  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-pp-standard" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-standard" class="form-horizontal">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="pp_standard_email" value="<?php echo $pp_standard_email; ?>" id="input-email" class="form-control" />
            <?php if ($error_email) { ?>
		...
		<div class="btn-group" data-toggle="buttons">
  			...
  			<label class="btn btn-primary<?php if ($pp_standard_test == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="pp_standard_test" value="1" <?php if ($pp_standard_test == 1) { ?>checked="checked"<?php } ?>> <?php echo $text_yes; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($pp_standard_test == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="pp_standard_test" value="0" <?php if ($pp_standard_test == 0) { ?>checked="checked"<?php } ?>> <?php echo $text_no; ?>
  			</label>
		</div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="pp_standard_total" value="<?php echo $pp_standard_total; ?>" id="input-total" class="form-control" />
	 </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
  		...
  		<label class="btn btn-primary<?php if ($pp_standard_status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="pp_standard_status" id="input-status" <?php if ($pp_standard_status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($pp_standard_status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="pp_standard_status" id="input-status" <?php if ($pp_standard_status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="pp_standard_sort_order" value="<?php echo $pp_standard_sort_order; ?>" id="input-sort-order" class="form-control" />
          </div>
        </div>
      </form>
    </div>
