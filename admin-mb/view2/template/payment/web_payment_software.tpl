  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-web-payment-software" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-web-payment-software" class="form-horizontal">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="web_payment_software_merchant_name" value="<?php echo $web_payment_software_merchant_name; ?>" id="input-login" class="form-control" />
            <?php if ($error_login) { ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="web_payment_software_merchant_key" value="<?php echo $web_payment_software_merchant_key; ?>" id="input-key" class="form-control" />
            <?php if ($error_key) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="web_payment_software_total" value="<?php echo $web_payment_software_total; ?>" id="input-total" class="form-control" />
	 </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
  		...
  		<label class="btn btn-primary<?php if ($web_payment_software_status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="web_payment_software_status" id="input-status" <?php if ($web_payment_software_status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($web_payment_software_status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="web_payment_software_status" id="input-status" <?php if ($web_payment_software_status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="web_payment_software_sort_order" value="<?php echo $web_payment_software_sort_order; ?>" id="input-sort-order" class="form-control" />
          </div>
        </div>
      </form>
    </div>
