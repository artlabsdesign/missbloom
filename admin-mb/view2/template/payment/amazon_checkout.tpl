  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-amazon-checkout" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="amazon_checkout_access_id"><?php echo $text_merchant_id ?></label>
          <div class="col-sm-10">
	...
	<div class="form-group">
          <label class="col-sm-2 control-label" for="cron-job-url"><?php echo $text_cron_job_url ?></label>
          <div class="col-sm-10">
	...
	<div class="form-group">
          <label class="col-sm-2 control-label" for="last_cron-job-url"><?php echo $text_last_cron_job_run ?></label>
          <div class="col-sm-10">
		<input name="last_cron-job-url" value="<?php echo $last_cron_job_run ?>" id="last_cron-job-url" class="form-control" />
          </div>
        </div>
	<div class="form-group">
          <label class="col-sm-2 control-label" for="allowed-ip"><?php echo $text_allowed_ips ?></label>
...
<a class="btn btn-primary" id="add-ip"><?php echo $text_add ?></a></span></div>
	...
	<div class="form-group">
          <label class="col-sm-2 scrollbox control-label" for="allowed-ip"></label>
          <div class="col-sm-10">
                      <?php $class = 'odd' ?>
                      <?php $count = 0 ?>
                      <?php foreach ($amazon_checkout_allowed_ips as $ip): ?>
                      <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                          <div id="allowed-ip<?php echo $count++ ?>" class="col-sm-10 <?php echo $class ?>"><?php echo $ip ?> <img src="view/image/delete.png" alt="" />
