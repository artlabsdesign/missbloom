  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" onclick="$('#form').submit();" form="form-authorizenet-aim" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
...
<div class="tab-content">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_username"><?php echo $entry_username; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_password"><?php echo $entry_password; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_signature"><?php echo $entry_signature; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_ipn"><?php echo $text_ipn; ?></label>
            <div class="col-sm-10">
			<input type="text" name="pp_ipn" value="<?php echo $text_ipn_url; ?>" class="form-control"/>
                ...
                <div class="tab-pane" id="tab-general">
                    	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_test"><?php echo $entry_test; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_debug"><?php echo $entry_debug; ?></label>
            <div class="col-sm-10">
		<div class="btn-group" data-toggle="buttons">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_method"><?php echo $entry_method; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_total"><?php echo $entry_total; ?></label>
            <div class="col-sm-10">
			<input type="text" name="pp_express_total" value="<?php echo $pp_express_total; ?>" class="form-control" />
                        </div>
                        </div>
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_geo_zone_id"><?php echo $entry_geo_zone; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_currency"><?php echo $entry_currency; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_status"><?php echo $entry_status; ?></label>
            <div class="col-sm-10">
		<div class="btn-group" data-toggle="buttons">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_sort_order"><?php echo $entry_sort_order; ?></label>
            <div class="col-sm-10">
		<input type="text" name="pp_express_sort_order" value="<?php echo $pp_express_sort_order; ?>" class="form-control"/></td>
             </div>
	</div>
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_profile_cancel_status"><?php echo $entry_profile_cancellation ?></label>
            <div class="col-sm-10">
		<div class="btn-group" data-toggle="buttons">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_canceled_reversal_status_id"><?php echo $entry_canceled_reversal_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_canceled_reversal_status_id"><?php echo $entry_completed_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_canceled_reversal_status_id"><?php echo $entry_denied_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_expired_status_id"><?php echo $entry_expired_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_failed_status_id"><?php echo $entry_failed_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_pending_status_id"><?php echo $entry_pending_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_pending_status_id"><?php echo $entry_processed_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_refunded_status_id"><?php echo $entry_refunded_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_refunded_status_id"><?php echo $entry_reversed_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_voided_status_id"><?php echo $entry_voided_status; ?></label>
            <div class="col-sm-10">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_allow_note"><?php echo $entry_allow_notes; ?></label>
            <div class="col-sm-10">
		<div class="btn-group" data-toggle="buttons">
	...
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_border_colour"><?php echo $entry_border_colour; ?></label>
            <div class="col-sm-10">
		<input type="color" name="pp_express_border_colour" value="<?php echo $pp_express_border_colour; ?>" class="form-control"/>
                        </div>
                        </div>
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_header_colour"><?php echo $entry_header_colour; ?></label>
            <div class="col-sm-10">
		<input type="color" name="pp_express_header_colour" value="<?php echo $pp_express_header_colour; ?>" class="form-control"/>
                        </div>
                        </div>
	<div class="form-group required">
          <label class="col-sm-2 control-label" for="pp_express_page_colour"><?php echo $entry_page_colour; ?></label>
            <div class="col-sm-10">
