            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($language['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $language['name'] = str_replace('<b>(', '<span class="label label-danger">', $language['name']);$language['name'] = str_replace(')</b>', '</span>', $language['name']); echo $language['name']; ?></td>
