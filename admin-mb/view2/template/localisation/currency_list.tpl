            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($currency['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $currency['title'] = str_replace('<b>(', '<span class="label label-danger">', $currency['title']);$currency['title'] = str_replace(')</b>', '</span>', $currency['title']); echo $currency['title']; ?></td>
