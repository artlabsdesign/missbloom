  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-language" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-language" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="locale" value="<?php echo $locale; ?>" id="input-locale" class="form-control" />
            <?php if ($error_locale) { ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="image" value="<?php echo $image; ?>" id="input-image" class="form-control" />
            <?php if ($error_image) { ?>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="directory" value="<?php echo $directory; ?>" id="input-directory" class="form-control" />
