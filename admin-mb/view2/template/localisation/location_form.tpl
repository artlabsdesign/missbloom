  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-location" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-location" class="form-horizontal">
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              <input type="text" name="geocode" value="<?php echo $geocode; ?>" id="input-geocode" class="form-control" />
              <span class="input-group-btn">
              <button type="button" onclick="getGeoCode()" class="btn btn-primary"><i class="fa fa-search"></i> <?php echo $button_geocode; ?></button>
              </span></div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10"><img src="<?php echo $thumb; ?>" alt="" class="img-thumbnail" />
            ...
            <br />
            <div class="btn-group">
              <button type="button" data-toggle="modal" data-target="#modal" class="btn btn-info"><span class="fa fa-pencil"></span> <?php echo $button_edit; ?></button>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea name="open" rows="5" id="input-open" class="form-control"><?php echo $open; ?></textarea>
	</div>
        </div>
        <div class="form-group">
