            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($return_status['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $return_status['name'] = str_replace('<b>(', '<span class="label label-danger">', $return_status['name']);$return_status['name'] = str_replace(')</b>', '</span>', $return_status['name']); echo $return_status['name']; ?></td>
