  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-tax-class" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form-tax-class">
        ...
        <table id="tax-rule" class="table table-striped table-bordered table-hover">
          ...
          <tfoot>
            <tr>
              <td colspan="3"></td>
              <td class="text-left"><button type="button" onclick="addRule();" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_rule; ?></button></td>
            </tr>
          </tfoot>
        </table>
      </form>
