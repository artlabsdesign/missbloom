            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($stock_status['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $stock_status['name'] = str_replace('<b>(', '<span class="label label-danger">', $stock_status['name']);$stock_status['name'] = str_replace(')</b>', '</span>', $stock_status['name']); echo $stock_status['name']; ?></td>
