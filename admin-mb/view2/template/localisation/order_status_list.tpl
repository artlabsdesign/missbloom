            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($order_status['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $order_status['name'] = str_replace('<b>(', '<span class="label label-danger">', $order_status['name']);$order_status['name'] = str_replace(')</b>', '</span>', $order_status['name']); echo $order_status['name']; ?></td>
