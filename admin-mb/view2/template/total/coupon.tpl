      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
        <div class="form-group">
          ...
          <div class="col-sm-10">
  			...
  			<label class="btn btn-primary<?php if ($coupon_status == 1) { ?> active<?php } ?>">
  			...
  			<label class="btn btn-primary<?php if ($coupon_status == 0) { ?> active<?php } ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="coupon_sort_order" value="<?php echo $coupon_sort_order; ?>" id="input-sort-order" class="form-control" />
          </div>
        </div>
      </form>
    </div>
