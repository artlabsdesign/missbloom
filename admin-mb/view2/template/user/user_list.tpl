          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><span<?php echo ($this->language->get('text_disabled') == $user['status'])?' class="label label-warning"':' class="label label-primary"'; ?>><?php echo $user['status']; ?></span></td>
