...
<table class="form">
          ...
          <tr>
            <td>Module title:</td>
<td><input type="text" name="pricetables_module[<?php echo $module_row; ?>][module_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['module_title'][$language['language_id']]) ? $module['module_title'][$language['language_id']] : ''; ?>" size="40" /></td>
</tr>
</table>
</div>
<?php } ?>
        ...
        <table class="form">
          <tr>
            ...
            <td><select name="pricetables_module[<?php echo $module_row; ?>][layout_id]">
          ...
          <tr>
            ...
            <td><select name="pricetables_module[<?php echo $module_row; ?>][position]">
          ...
          <tr>
            ...
            <td><select name="pricetables_module[<?php echo $module_row; ?>][status]">
          ...
          <tr>
            ...
            <td><input type="text" name="pricetables_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
          </tr>
        </table>
          ...
          <tbody id="section-row-<?php echo $module_row; ?>-<?php echo $section_row; ?>" class="section">
            <tr>
              <td class="left"><div class="choose_icon">
                  ...
                  Select icon:<br /><br /><select name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon]" class="spicy">
                    <?php if ($section['icon'] != '') {
                    ...
                    <option value="icon-bar-chart" <?php if($section['icon']=='icon-bar-chart'){echo $selected_icon;} ?>>Bar chart</option>
                    ...
                    <option value="icon-desktop" <?php if($section['icon']=='icon-desktop'){echo $selected_icon;} ?>>Desktop</option>
                    ...
                    <option value="icon-eye-open" <?php if($section['icon']=='icon-eye-open'){echo $selected_icon;} ?>>Eye</option>
                    <option value="icon-eye-slash" <?php if($section['icon']=='icon-eye-open-slash'){echo $selected_icon;} ?>>Eye slash</option>
                    ...
                    <option value="icon-mobile-phone" <?php if($section['icon']=='icon-mobile-phone'){echo $selected_icon;} ?>>Mobile phone</option>
                    ...
                    <option value="icon-eye-open">Eye</option>
                  ...
                  Icon background: 
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon_color]" id="icon_color-<?php echo $module_row; ?>-<?php echo $section_row; ?>" value="<?php echo $module['sections'][$section_row]['icon_color']; ?>" size="7" class="spicy choose" style="background-color:#<?php echo $module['sections'][$section_row]['icon_color']; ?>;"/>
                  <br />
                  <br />
                  
                </div>
                <div class="choose_icon">
                  Select active state:<br /><br /><select name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][state]" class="spicy">
                    <?php if ($section['state'] != '') {
              					$selected_state = 'selected="selected"';
              					?>
                    <option value="yes" <?php if($section['state']=='yes'){echo $selected_state;} ?>>Yes</option>
                    <option value="no" <?php if($section['state']=='no'){echo $selected_state;} ?>>No</option>
                    <?php } else { ?>
                ...
                <div class="choose_icon">
                  Button/Link:<br /><br /><input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_button]" id="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_button]" value="<?php echo $section['line_button']; ?>" size="60" class="spicy" />
                </div>
                ...
                <?php foreach ($languages as $language) { ?>
                <div id="tab-language-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" class="tabs-content"> Title:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][title][<?php echo $language['language_id']; ?>]" id="title-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['title'][$language['language_id']]) ? $module['sections'][$section_row]['title'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Price:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_price][<?php echo $language['language_id']; ?>]" id="line_price-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_price'][$language['language_id']]) ? $module['sections'][$section_row]['line_price'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Period:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_period][<?php echo $language['language_id']; ?>]" id="line_period-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_period'][$language['language_id']]) ? $module['sections'][$section_row]['line_period'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 1:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option1][<?php echo $language['language_id']; ?>]" id="line_option1-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option1'][$language['language_id']]) ? $module['sections'][$section_row]['line_option1'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 2:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option2][<?php echo $language['language_id']; ?>]" id="line_option2-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option2'][$language['language_id']]) ? $module['sections'][$section_row]['line_option2'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 3:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option3][<?php echo $language['language_id']; ?>]" id="line_option3-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option3'][$language['language_id']]) ? $module['sections'][$section_row]['line_option3'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 4:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option4][<?php echo $language['language_id']; ?>]" id="line_option4-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option4'][$language['language_id']]) ? $module['sections'][$section_row]['line_option4'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 5:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option5][<?php echo $language['language_id']; ?>]" id="line_option5-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option5'][$language['language_id']]) ? $module['sections'][$section_row]['line_option5'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 6:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option6][<?php echo $language['language_id']; ?>]" id="line_option6-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option6'][$language['language_id']]) ? $module['sections'][$section_row]['line_option6'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 7:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option7][<?php echo $language['language_id']; ?>]" id="line_option7-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option7'][$language['language_id']]) ? $module['sections'][$section_row]['line_option7'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                  <br />
                  <br />
                  Option 8:<br />
                  <input name="pricetables_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][line_option8][<?php echo $language['language_id']; ?>]" id="line_option8-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['line_option8'][$language['language_id']]) ? $module['sections'][$section_row]['line_option8'][$language['language_id']] : ''; ?>" size="60" class="spicy" />
                </div>
                <?php } ?></td>
...
function addModule() {	
    ...
    html += '    <td><input type="text" name="pricetables_module[' + module_row + '][module_title][<?php echo $language['language_id']; ?>]" size="40" /></td>';
    html += '    </tr>';
    html += '    </table>';
	html += '      </div>';
    <?php } ?>
	...
	html += '      <td><select name="pricetables_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="pricetables_module[' + module_row + '][position]">';
	...
	html += '      <td><select name="pricetables_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" name="pricetables_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
...
function addSection( module_number) {
	...
	html += '    Select icon:<br /><br /><select name="pricetables_module[' + module_number + '][sections][' + section_row + '][icon]" class="spicy">';
	...
	html += '    <option value="icon-desktop">Desktop</option>';
	...
	html += '    <option value="icon-eye-open">Eye</option>';
	...
	html += '    <option value="icon-mobile-phone">Mobile phone</option>';
	...
	html += '    </select>';
	html += '          	Icon Background: <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][icon_color]" id="icon_color-' + module_number + '-' + section_row +'" size="7" /><br /><br />';
	html += '    </div>';
	html += '    <div class="choose_icon">';
	html += '    Select active state:<br /><br /><select name="pricetables_module[' + module_number + '][sections][' + section_row + '][state]" class="spicy">';
	html += '    <option value="yes">Yes</option>';
	html += '    <option value="no">No</option>';	
	html += '    </select>';
	html += '    </div>';
	html += '    <div class="choose_icon">';
	html += '    Button/Link:<br /><br /><input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_button]" id="pricetables_module[' + module_number + '][sections][' + section_row + '][line_button]" size="60" class="spicy" />';
	html += '    </div>';
	...
	html += '          	Title:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][title][<?php echo $language['language_id']; ?>]" id="title-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Price:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_price][<?php echo $language['language_id']; ?>]" id="line_price-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
		html += '       Period:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_period][<?php echo $language['language_id']; ?>]" id="line_period-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 1:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option1][<?php echo $language['language_id']; ?>]" id="line_option1-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 2:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option2][<?php echo $language['language_id']; ?>]" id="line_option2-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 3:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option3][<?php echo $language['language_id']; ?>]" id="line_option3-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 4:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option4][<?php echo $language['language_id']; ?>]" id="line_option4-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 5:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option5][<?php echo $language['language_id']; ?>]" id="line_option5-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 6:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option6][<?php echo $language['language_id']; ?>]" id="line_option6-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 7:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option7][<?php echo $language['language_id']; ?>]" id="line_option7-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	html += '          	Option 8:<br /> <input name="pricetables_module[' + module_number + '][sections][' + section_row + '][line_option8][<?php echo $language['language_id']; ?>]" id="line_option8-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" class="spicy" /><br /><br />';
	...
	$('#icon_color-' + module_number + '-' + section_row +'').ColorPicker({
