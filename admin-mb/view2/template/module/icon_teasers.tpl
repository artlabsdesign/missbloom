...
<table class="form">
          ...
          <tr>
            <td>Module title:</td>
<td><input type="text" name="icon_teasers_module[<?php echo $module_row; ?>][module_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['module_title'][$language['language_id']]) ? $module['module_title'][$language['language_id']] : ''; ?>" size="40" /></td>
</tr>
</table>
</div>
<?php } ?>
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="icon_teasers_module[<?php echo $module_row; ?>][layout_id]">
          ...
          <tr>
            ...
            <td><select name="icon_teasers_module[<?php echo $module_row; ?>][position]">
            <?php if ($module['position'] == 'icon_teaser') { ?>
                <option value="icon_teaser" selected="selected">Product Icon teasers</option>
                <?php } else { ?>
                <option value="icon_teaser">Product Icon teasers</option>
                <?php } ?>
                <?php if ($module['position'] == 'header_icon_teaser') { ?>
                <option value="header_icon_teaser" selected="selected">Header Icon teasers</option>
                <?php } else { ?>
                <option value="header_icon_teaser">Header Icon teasers</option>
                <?php } ?>
                <?php if ($module['position'] == 'footer_icon_teaser') { ?>
                <option value="footer_icon_teaser" selected="selected">Footer Icon teasers</option>
                <?php } else { ?>
                <option value="footer_icon_teaser">Footer Icon teasers</option>
                <?php } ?>
              </select></td>
          </tr>
          <tr>
            <td><?php echo $entry_status; ?></td>
            <td><select name="icon_teasers_module[<?php echo $module_row; ?>][status]">
          ...
          <tr>
            ...
            <td><input type="text" name="icon_teasers_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
          </tr>
        </table>
          ...
          <tbody id="section-row-<?php echo $module_row; ?>-<?php echo $section_row; ?>" class="section">
            <tr>
              ...
              <td class="left"><div class="choose_icon">
                  ...
                  <select name="icon_teasers_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon]" class="spicy">
                    <?php if ($section['icon'] != '') {
                  ...
                  Icon background: 
                  <input name="icon_teasers_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon_color]" id="icon_color-<?php echo $module_row; ?>-<?php echo $section_row; ?>" value="<?php echo $module['sections'][$section_row]['icon_color']; ?>" size="7" class="spicy choose" style="background-color:#<?php echo $module['sections'][$section_row]['icon_color']; ?>;"/>
                  <br />
                  <br />
                  
                   Link to another page on click: 
                  <input name="icon_teasers_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon_link]" id="icon_link-<?php echo $module_row; ?>-<?php echo $section_row; ?>" value="<?php echo $module['sections'][$section_row]['icon_link']; ?>" size="35" class="spicy" style="background-color:#<?php echo $module['sections'][$section_row]['icon_link']; ?>;"/>
                  <br />
                  <br />
                  <br />
                ...
                <?php foreach ($languages as $language) { ?>
                <div id="tab-language-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" class="tabs-content"> <?php echo $text_title; ?>
                  <input name="icon_teasers_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][title][<?php echo $language['language_id']; ?>]" id="title-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['title'][$language['language_id']]) ? $module['sections'][$section_row]['title'][$language['language_id']] : ''; ?>" size="50" />
                  <br />
                  <br />
                  Sub-title: 
                  <input name="icon_teasers_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][sub_title][<?php echo $language['language_id']; ?>]" id="sub_title-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['sub_title'][$language['language_id']]) ? $module['sections'][$section_row]['sub_title'][$language['language_id']] : ''; ?>" size="50" />
                  <br />
                  <br />
                  <textarea name="icon_teasers_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['sections'][$section_row]['description'][$language['language_id']]) ? $module['sections'][$section_row]['description'][$language['language_id']] : ''; ?></textarea>
                </div>
                <?php } ?></td>
...
function addModule() {	
    ...
    html += '    <td><input type="text" name="icon_teasers_module[' + module_row + '][module_title][<?php echo $language['language_id']; ?>]" size="40" /></td>';
    html += '    </tr>';
    html += '    </table>';
	html += '      </div>';
    <?php } ?>
	...
	html += '      <td><select name="icon_teasers_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="icon_teasers_module[' + module_row + '][position]">';
	html += '        <option value="icon_teaser">Product Icon teaser</option>';
	html += '        <option value="header_icon_teaser">Header Icon teaser</option>';
	html += '        <option value="footer_icon_teaser">Footer Icon teaser</option>';
	html += '      </select></td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_status; ?></td>';
	html += '      <td><select name="icon_teasers_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" name="icon_teasers_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
...
function addSection( module_number) {
	...
	html += '    <select name="icon_teasers_module[' + module_number + '][sections][' + section_row + '][icon]" class="spicy">';
	...
	html += '    </select>';
	html += '          	Icon Background: <input name="icon_teasers_module[' + module_number + '][sections][' + section_row + '][icon_color]" id="icon_color-' + module_number + '-' + section_row +'" size="7" /><br /><br />';
	html += '          	Link to another page on click: <input name="icon_teasers_module[' + module_number + '][sections][' + section_row + '][icon_link]" id="icon_link-' + module_number + '-' + section_row +'"  size="35" class="spicy" /><br /><br />';
	html += '    </div>';
	...
	html += '          	<?php echo $text_title; ?><input name="icon_teasers_module[' + module_number + '][sections][' + section_row + '][title][<?php echo $language['language_id']; ?>]" id="title-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" /><br /><br />';
		html += '          	Sub-title: <input name="icon_teasers_module[' + module_number + '][sections][' + section_row + '][sub_title][<?php echo $language['language_id']; ?>]" id="sub_title-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" /><br /><br />';
	html += '          	<textarea name="icon_teasers_module[' + module_number + '][sections][' + section_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_number + '-' + section_row + '-<?php echo $language['language_id']; ?>"></textarea>';
	html += '    	</div>';
					<?php } ?>
	html += '    </td>';
