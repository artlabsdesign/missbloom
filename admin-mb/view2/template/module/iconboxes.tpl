...
<table class="form">
          ...
          <tr>
            <td>Module title:</td>
<td><input type="text" name="iconboxes_module[<?php echo $module_row; ?>][module_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['module_title'][$language['language_id']]) ? $module['module_title'][$language['language_id']] : ''; ?>" size="40" /></td>
</tr>
</table>
</div>
<?php } ?>
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td><select name="iconboxes_module[<?php echo $module_row; ?>][layout_id]">
          ...
          <tr>
            ...
            <td><select name="iconboxes_module[<?php echo $module_row; ?>][position]">
          ...
          <tr>
            ...
            <td><select name="iconboxes_module[<?php echo $module_row; ?>][status]">
          ...
          <tr>
            ...
            <td><input type="text" name="iconboxes_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
          </tr>
        </table>
          ...
          <tbody id="section-row-<?php echo $module_row; ?>-<?php echo $section_row; ?>" class="section">
            <tr>
              ...
              <td class="left"><div class="choose_icon">
                  ...
                  <select name="iconboxes_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon]" class="spicy">
                    <?php if ($section['icon'] != '') {
                ...
                <div id="tab-language-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" class="tabs-content"> <?php echo $text_title; ?>
                  <input name="iconboxes_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][title][<?php echo $language['language_id']; ?>]" id="title-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['title'][$language['language_id']]) ? $module['sections'][$section_row]['title'][$language['language_id']] : ''; ?>" size="50" />
                  <br />
                  <br />
                  <textarea name="iconboxes_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['sections'][$section_row]['description'][$language['language_id']]) ? $module['sections'][$section_row]['description'][$language['language_id']] : ''; ?></textarea>
                </div>
                <?php } ?></td>
...
function addModule() {	
    ...
    html += '    <td><input type="text" name="iconboxes_module[' + module_row + '][module_title][<?php echo $language['language_id']; ?>]" size="40" /></td>';
    html += '    </tr>';
    html += '    </table>';
	html += '      </div>';
    <?php } ?>
	...
	html += '      <td><select name="iconboxes_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="iconboxes_module[' + module_row + '][position]">';
	...
	html += '      <td><select name="iconboxes_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" name="iconboxes_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
...
function addSection( module_number) {
	...
	html += '    <select name="iconboxes_module[' + module_number + '][sections][' + section_row + '][icon]" class="spicy">';
	...
	html += '          	<?php echo $text_title; ?><input name="iconboxes_module[' + module_number + '][sections][' + section_row + '][title][<?php echo $language['language_id']; ?>]" id="title-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" /><br /><br />';
	html += '          	<textarea name="iconboxes_module[' + module_number + '][sections][' + section_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_number + '-' + section_row + '-<?php echo $language['language_id']; ?>"></textarea>';
	html += '    	</div>';
					<?php } ?>
	html += '    </td>';
