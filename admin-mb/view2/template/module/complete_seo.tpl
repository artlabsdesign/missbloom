...
<div class="box">
  ...
  <div class="content">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<tr>
          <td><?php echo $this->language->get('text_seo_urlcache'); ?></td>
      ...
      <table class="form">
        ...
        <tr>
          ...
          <td><?php echo $this->language->get('text_seo_ascii'); ?></td>
						<td>
							<?php foreach ($languages as $language) { ?>
							<label style="padding-right:40px;"><input type="checkbox" name="multilingual_seo_ascii_<?php echo $language['language_id']; ?>" value="1"  <?php if($this->config->get('multilingual_seo_ascii_'.$language['language_id'])) echo 'checked="checked"'; ?>/> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></label>
						<?php } ?>
						</td>
        </tr>
        <tr>
		...
		<tr>
          <td><?php echo $this->language->get('text_cache'); ?></td>
          <td>
				<a onclick="seo_update('cache', 'create');" class="button"><span><?php echo $this->language->get('text_cache_create_btn'); ?></span></a>
				<a onclick="seo_update('cache', 'delete');" class="button"><span><?php echo $this->language->get('text_cache_delete_btn'); ?></span></a>
			</td>
        </tr>
		<tr>
