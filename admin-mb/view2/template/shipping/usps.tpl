  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-usps" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-usps" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
  			...
  			<label class="btn btn-primary<?php if ($usps_status == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="usps_status" id="input-status" <?php if ($usps_status == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($usps_status == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="usps_status" id="input-status" <?php if ($usps_status == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
                <div class="btn-group" data-toggle="buttons">
  			<label class="btn btn-primary<?php if ($usps_debug == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="usps_debug" id="input-status" <?php if ($usps_debug == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-primary<?php if ($usps_debug == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="usps_debug" id="input-status" <?php if ($usps_debug == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
	 </div>
        </div>
