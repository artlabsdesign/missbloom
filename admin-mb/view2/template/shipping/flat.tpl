  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-flat" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-flat" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
  			...
  			<label class="btn btn-primary<?php if ($flat_status == 1) { ?> active<?php } ?>">
  			...
  			<label class="btn btn-primary<?php if ($flat_status == 0) { ?> active<?php } ?>">
