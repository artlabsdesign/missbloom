  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right"><a href="<?php echo $insert; ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> <?php echo $button_insert; ?></a>
        <button type="submit" form="form-product" formaction="<?php echo $copy; ?>" class="btn btn-success btn-xs"><i class="fa fa-copy"></i> <?php echo $button_copy; ?></button>
        <div class="btn-group">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right hidden-xs"><?php if ($product['quantity'] <= 0) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left hidden-xs"><span<?php echo ($this->language->get('text_disabled') == $product['status'])?' class="label label-warning"':' class="label label-primary"'; ?>><?php echo $product['status']; ?></span></td>
                <td class="text-right"><?php foreach ($product['action'] as $action) { ?>
                  <a href="<?php echo $action['href']; ?>" data-toggle="tooltip" title="<?php echo $action['text']; ?>" class="btn <?php if ( isset($text_disabled) && $text_disabled == $product['status'] ) { echo " btn-warning"; } else { echo " btn-primary"; } ?>"><i class="fa fa-edit"></i> <?php echo $action['text']; ?></a>
                  <?php } ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
