  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-product" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-data">
            ...
            <div class="form-group">
  			...
  			<label class="btn btn-primary<?php if ($subtract == 1) { ?> active<?php } ?>">
  			...
  			<label class="btn btn-primary<?php if ($subtract == 0) { ?> active<?php } ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div class="btn-group" data-toggle="buttons">
  			<label class="btn btn-primary<?php if ($shipping == 1) { ?> active<?php } ?>">
  			...
  			<label class="btn btn-primary<?php if ($shipping == 0) { ?> active<?php } ?>">
            ...
            <div class="table-responsive">
              <table id="attribute" class="table table-striped table-bordered table-hover">
                ...
                <tfoot>
                  <tr>
                    <td colspan="2"></td>
                    <td class="text-left"><button type="button" onclick="addAttribute();" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_attribute; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="tab-option<?php echo $option_row; ?>">
                    ...
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-value<?php echo $option_row; ?>"><?php echo $entry_option_value; ?></label>
                      <div class="col-sm-10">
                        <input type="date" name="product_option[<?php echo $option_row; ?>][option_value]" value="<?php echo $product_option['option_value']; ?>" id="input-value<?php echo $option_row; ?>" class="form-control" />
                      </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="table-responsive">
                      <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="6"></td>
                            <td class="text-left"><button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_option_value; ?></button></td>
                          </tr>
                        </tfoot>
                      </table>
                    </div>
            ...
            <div class="table-responsive">
              <table id="discount" class="table table-striped table-bordered table-hover">
                ...
                <tfoot>
                  <tr>
                    <td colspan="6"></td>
                    <td class="text-left"><button type="button" onclick="addDiscount();" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_discount; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
            ...
            <div class="table-responsive">
              <table id="special" class="table table-striped table-bordered table-hover">
                ...
                <tfoot>
                  <tr>
                    <td colspan="5"></td>
                    <td class="text-left"><button type="button" onclick="addSpecial();" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_special; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
            ...
            <div class="table-responsive">
              <table id="images" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-left"><div class="btn-group">
                        <button type="button" onclick="image_upload('image<?php echo $image_row; ?>', 'thumb<?php echo $image_row; ?>');" data-toggle="modal" data-target="#dialog" class="btn btn-info"><span class="fa fa-pencil"></span> <?php echo $text_browse; ?></button>
                        <button type="button" onclick="$('#thumb<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $image_row; ?>').attr('value', '');return false;" class="btn btn-danger"><span class="fa fa-trash-o"></span> <?php echo $text_clear; ?></button>
                      </div></td>
                ...
                <tfoot>
                  <tr>
                    <td colspan="3"></td>
                    <td class="text-left"><button type="button" onclick="addImage();" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_image; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		html += '	  <div class="col-sm-10"><div class="btn-group" data-toggle="buttons">';
		...
		if (item['type'] == 'text') {
			...
			html += '	  <div class="col-sm-10"><input type="text" name="product_option[' + option_row + '][option_value]" value="" id="input-value' + option_row + '" class="form-control" /></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'textarea') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><textarea name="product_option[' + option_row + '][option_value]" rows="5" id="input-value' + option_row + '" class="form-control"></textarea></div>';
			html += '	</div>';			
		}
		...
		if (item['type'] == 'date') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><input type="date" name="product_option[' + option_row + '][option_value]" value="" id="input-value' + option_row + '" class="form-control" /></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'datetime') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><input type="datetime-local" name="product_option[' + option_row + '][option_value]" value="" id="input-value' + option_row + '" class="form-control" /></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'time') {
			html += '	<div class="form-group">';
			html += '	  <label class="col-sm-2 control-label" for="input-value' + option_row + '"><?php echo $entry_option_value; ?></label>';
			html += '	  <div class="col-sm-10"><input type="time" name="product_option[' + option_row + '][option_value]" value="" id="input-value' + option_row + '" class="form-control" /></div>';
			html += '	</div>';
		}
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-left"><button type="button" onclick="addOptionValue(' + option_row + ');" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_add_option_value; ?></button></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
			html += '</div>';
