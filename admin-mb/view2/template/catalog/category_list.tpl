...
<div id="content" class="container">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right"><a href="<?php echo $insert; ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i> <?php echo $button_insert; ?></a> <a href="<?php echo $repair; ?>" class="btn btn-success btn-xs"><i class="fa fa-wrench"></i> <?php echo $button_repair; ?></a>
        <div class="btn-group">
    ...
    <div class="panel-body">
      ...
      <div class="row">
        <div class="text-left col-sm-6 "><?php 
if ($pagination){
$str = $pagination;
