...
<table class="form">
          ...
          <tr>
            <td>Module title:</td>
<td><input type="text" name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][module_title][<?php echo $language['language_id']; ?>]" value="<?php echo isset($module['module_title'][$language['language_id']]) ? $module['module_title'][$language['language_id']] : ''; ?>" size="40" /></td>
</tr>
</table>
</div>
<?php } ?>
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td class="left">
            <select name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][tabsmode]" class="spicy">
                    <?php if ($module['tabsmode'] != '') {
              					$selected_mode = 'selected="selected"';
              					?>
                    <option value="ULTIMATUMtabs_tabs.php" <?php if($module['tabsmode']=='ULTIMATUMtabs_tabs.php'){echo $selected_mode;} ?>>Tabs</option>
                    <option value="ULTIMATUMtabs_accordeon.php" <?php if($module['tabsmode']=='ULTIMATUMtabs_accordeon.php'){echo $selected_mode;} ?>>Accordion</option>
                    <option value="ULTIMATUMtabs_toggle.php" <?php if($module['tabsmode']=='ULTIMATUMtabs_toggle.php'){echo $selected_mode;} ?>>Toggle</option>
                    <?php } else { ?>
                    <option value="ULTIMATUMtabs_tabs.php" selected="selected">Tabs</option>
                    <option value="ULTIMATUMtabs_accordeon.php">Accordion</option>
                    <option value="ULTIMATUMtabs_toggle.php">Toggle</option>
                    <?php } ?>
                  </select>
            </td>
          </tr>
          <tr>
            ...
            <td><select name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][layout_id]" class="spicy">
          ...
          <tr>
            ...
            <td><select name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][position]" class="spicy">
          ...
          <tr>
            ...
            <td><select name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][status]" class="spicy">
          ...
          <tr>
            ...
            <td><input type="text" name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" class="spicy" /></td>
          </tr>
        </table>
          ...
          <tbody id="section-row-<?php echo $module_row; ?>-<?php echo $section_row; ?>" class="section">
            <tr>
              ...
              <td class="left"><div class="choose_icon">
                  ...
                  <select name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][icon]" class="spicy">
                    <?php if ($section['icon'] != '') {
                ...
                <div id="tab-language-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>"> <?php echo $text_title; ?>
                  <input name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][title][<?php echo $language['language_id']; ?>]" id="title-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>" value="<?php echo isset($module['sections'][$section_row]['title'][$language['language_id']]) ? $module['sections'][$section_row]['title'][$language['language_id']] : ''; ?>" size="50" />
                  <br />
                  <br />
                  <textarea name="ULTIMATUMtabs_module[<?php echo $module_row; ?>][sections][<?php echo $section_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $section_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['sections'][$section_row]['description'][$language['language_id']]) ? $module['sections'][$section_row]['description'][$language['language_id']] : ''; ?></textarea>
                </div>
                <?php } ?></td>
...
function addModule() {	
    ...
    html += '    <td><input type="text" name="ULTIMATUMtabs_module[' + module_row + '][module_title][<?php echo $language['language_id']; ?>]" size="40" /></td>';
    html += '    </tr>';
    html += '    </table>';
	html += '      </div>';
    <?php } ?>
	...
	html += '    <td>';
	html += '    <select name="ULTIMATUMtabs_module[' + module_row + '][tabsmode]" class="spicy">';
	html += '    <option value="ULTIMATUMtabs_tabs.php">Tabs</option>';
	html += '    <option value="ULTIMATUMtabs_accordeon.php">Accordion</option>';
	html += '    <option value="ULTIMATUMtabs_toggle.php">Toggle</option>';
	html += '    </select>';
	html += '    </td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select name="ULTIMATUMtabs_module[' + module_row + '][layout_id]" class="spicy">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="ULTIMATUMtabs_module[' + module_row + '][position]" class="spicy">';
	...
	html += '      <td><select name="ULTIMATUMtabs_module[' + module_row + '][status]" class="spicy">';
	...
	html += '      <td><input type="text" name="ULTIMATUMtabs_module[' + module_row + '][sort_order]" value="" size="3" class="spicy" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
...
function addSection( module_number) {
	...
	html += '    <select name="ULTIMATUMtabs_module[' + module_number + '][sections][' + section_row + '][icon]" class="spicy">';
	...
	html += '          	<?php echo $text_title; ?><input name="ULTIMATUMtabs_module[' + module_number + '][sections][' + section_row + '][title][<?php echo $language['language_id']; ?>]" id="title-' + module_number + '-' + section_row +'-<?php echo $language['language_id']; ?>" size="60" /><br /><br />';
	html += '          	<textarea name="ULTIMATUMtabs_module[' + module_number + '][sections][' + section_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_number + '-' + section_row + '-<?php echo $language['language_id']; ?>"></textarea>';
	html += '    	</div>';
					<?php } ?>
	html += '    </td>';
