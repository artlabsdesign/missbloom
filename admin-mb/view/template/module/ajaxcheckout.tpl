...
<div class="box">
 ...
 <div class="content">
  ...
  <div class="content">
       <div id="tab-ajaxcheckout">
    <div class="vtabs">
      <a href="#ajaxcheckout-settingmain"><?php echo $text_main_tab_setting; ?></a>
      <a href="#ajaxcheckout-settingfields"><?php echo $text_fields_tab_setting; ?></a>
      <a href="#ajaxcheckout-settingposition"><?php echo $text_position_tab_setting; ?></a>
    </div>
    <div id="ajaxcheckout-settingmain" class="vtabs-content">
      <table class="form">
                <tr>
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <select name="config_info_shipping">
                          ...
                          <option value="1" selected="selected"><?php echo $text_ajaxcheckout_yes; ?></option>
                          <option value="2" ><?php echo $text_ajaxcheckout_no; ?></option>
                          <option value=""  ><?php echo $text_ajaxcheckout_makeachoice; ?></option>
                          <?php } elseif ($config_info_shipping == "2") { ?>
                          <option value="1" ><?php echo $text_ajaxcheckout_yes; ?></option>
                          <option value="2" selected="selected"><?php echo $text_ajaxcheckout_no; ?></option>
                          <option value=""  ><?php echo $text_ajaxcheckout_makeachoice; ?></option>
                          <?php } else { ?>
                          <option value="1" ><?php echo $text_ajaxcheckout_yes; ?></option>
                          <option value="2" ><?php echo $text_ajaxcheckout_no; ?></option>
                          <option value=""  selected="selected"><?php echo $text_ajaxcheckout_makeachoice; ?></option>
                          <?php } ?>
                      </select>
                      &nbsp 
    ...
    <div id="ajaxcheckout-settingposition" class="vtabs-content">
      <table class="form">
                <tr>
    ...
    <div id="ajaxcheckout-settingfields" class="vtabs-content">
      <table class="form">
                <tr>
                  <td><?php echo $text_ajaxcheckout_hideimg; ?></td>
                  <td>
                 ...
                 <tr>
                  <td><?php echo $text_ajaxcheckout_hideshipping; ?></td>
                  <td>
                 ...
                 <tr>
                  <td><?php echo $text_ajaxcheckout_hidepayment; ?></td>
                  <td>
                 ...
                 <tr>
                  <td><?php echo $text_ajaxcheckout_hideoptions; ?></td>
                  <td>
                ...
                <tr>
                  <td><?php echo $text_ajaxcheckout_hidedescription; ?></td>
                  <td>
                ...
                <tr>
                  <td><?php echo $text_ajaxcheckout_hidefio; ?></td>
                  <td>
                      ...
                      &nbsp<?php echo $text_ajaxcheckout_required; ?>&nbsp
                ...
                <tr>
                  <td><?php echo $text_ajaxcheckout_hideemail; ?></td>
                  <td>
                 ...
                 <tr>
                  <td><?php echo $text_ajaxcheckout_hidetelephone; ?></td>
                  <td>
...
<style type="text/css">
#tab-ajaxcheckout {min-height: 320px;}
</style>
<?php echo $footer; ?>