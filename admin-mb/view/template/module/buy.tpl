      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          <table class="form">
              <tr>
                  ...
                  <td>
                    <select name="config_short_checkout_status">
                        <option value="0"<?php if($config_short_checkout_status == 0){?> selected="selected"<?php }?>><?php echo $text_disabled;?></option>
                        <option value="1"<?php if($config_short_checkout_status == 1){?> selected="selected"<?php }?>><?php echo $text_enabled;?></option>
                    </select>
                  </td>
              </tr>
              <tr>
              ...
              <tr>
                  <td><?php echo $entry_cart_modules; ?></td>
                  <td>
                    <select name="cart_modules">
                        <option value="0"<?php if(!isset($settings['cart_modules']) || $settings['cart_modules'] == 0){?> selected="selected"<?php }?>><?php echo $text_no;?></option>
                        <option value="1"<?php if(isset($settings['cart_modules']) && $settings['cart_modules'] == 1){?> selected="selected"<?php }?>><?php echo $text_yes;?></option>
                    </select>
                  </td>
              </tr>
              <tr>
                  <td><?php echo $entry_shipping_select; ?></td>
                  <td>
                    <select name="shipping_select">
                        <option value="0"<?php if(!isset($settings['shipping_select']) || $settings['shipping_select'] == 0){?> selected="selected"<?php }?>><?php echo $text_no;?></option>
                        <option value="1"<?php if(isset($settings['shipping_select']) && $settings['shipping_select'] == 1){?> selected="selected"<?php }?>><?php echo $text_yes;?></option>
                    </select>
                  </td>
              </tr>
              <tr>
                  <td><?php echo $entry_payment_select; ?></td>
                  <td>
                    <select name="payment_select">
                        <option value="0"<?php if(!isset($settings['payment_select']) || $settings['payment_select'] == 0){?> selected="selected"<?php }?>><?php echo $text_no;?></option>
                        <option value="1"<?php if(isset($settings['payment_select']) && $settings['payment_select'] == 1){?> selected="selected"<?php }?>><?php echo $text_yes;?></option>
                    </select>
                  </td>
              </tr>
          </table>
          ...
          <fieldset>
            ...
            <table class="form">
                ...
                <tr>
                    <td><b><?php echo $entry_zone;?></b></td>
                    <td>
                        <select name="zone_status" class="status">
                            <option value="0"<?php if(isset($settings['zone_status']) && $settings['zone_status'] == 0){?> selected="selected"<?php }?>><?php echo $text_disabled;?></option>
                            <option value="1"<?php if(isset($settings['zone_status']) && $settings['zone_status'] == 1){?> selected="selected"<?php }?>><?php echo $text_enabled;?></option>
                        </select>
                        <select name="zone_required">
                            <option value="0"<?php if(!isset($settings['zone_required']) || $settings['zone_required'] == 0){?> selected="selected"<?php }?>><?php echo $text_not_required;?></option>
                            <option value="1"<?php if(isset($settings['zone_required']) && $settings['zone_required'] == 1){?> selected="selected"<?php }?>><?php echo $text_required;?></option>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="comment_status" class="status">
                            <option value="0"<?php if(isset($settings['comment_status']) && $settings['comment_status'] == 0){?> selected="selected"<?php }?>><?php echo $text_disabled;?></option>
                            <option value="1"<?php if(isset($settings['comment_status']) && $settings['comment_status'] == 1){?> selected="selected"<?php }?>><?php echo $text_enabled;?></option>
                        </select>
                        <select name="comment_required">
                            <option value="0"<?php if(!isset($settings['comment_required']) || $settings['comment_required'] == 0){?> selected="selected"<?php }?>><?php echo $text_not_required;?></option>
                            <option value="1"<?php if(isset($settings['comment_required']) && $settings['comment_required'] == 1){?> selected="selected"<?php }?>><?php echo $text_required;?></option>
                        </select>
                    </td>
                </tr>
            </table>
