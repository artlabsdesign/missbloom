      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-customer" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><?php echo $order_status_email.$text_order_status_email; ?></td>
              <td><input type="checkbox" name="order_status_email" value="1"<?php if($order_status_email){ ?> checked="checked"<?php } ?> /></td>
            </tr>
            <tr>
              <td><?php echo $text_order_status_sms; ?></td>
              <td><input type="checkbox" name="order_status_sms" value="1"<?php if($order_status_sms){ ?> checked="checked"<?php } ?> /></td>
            </tr>
            <tr>
              <td><?php echo $text_newsletter; ?></td>
              <td><input type="checkbox" name="newsletter" value="1"<?php if($newsletter){ ?> checked="checked"<?php } ?> /></td>
            </tr>
          </table>
        </div>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr<?php if($rt==1){ ?> class="hide"<?php } ?> id="rt_name">
              <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>
              <td><input type="text" name="rt_name" value="<?php echo $rt_name; ?>" /></td>
            </tr>
            <tr<?php if($rt==2){ ?> class="hide"<?php } ?> id="shipping_firstname">
              <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>
              <td><input type="text" name="shipping_firstname" value="<?php echo $shipping_firstname; ?>" /></td>
            </tr>
            <tr id="rt_telephone">
              <td><?php echo $entry_telephone; ?></td>
              <td><input type="text" name="rt_telephone" value="<?php echo $rt_telephone; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_rt_clarify; ?></td>
              <td><input type="checkbox" name="rt_clarify" value="1"<?php if($rt_clarify){ ?> checked="checked"<?php } ?> /></td>
            </tr>
            <tr>
              <td><?php echo $text_address_type; ?></td>
              <td>
            ...
            <tr>
              <td><?php echo $text_street; ?></td>
              <td><input type="text" name="street" value="<?php echo $street; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_house; ?></td>
              <td><input type="text" name="house" value="<?php echo $house; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_building; ?></td>
              <td><input type="text" name="building" value="<?php echo $building; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_office; ?></td>
              <td><input type="text" name="office" value="<?php echo $office; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_flat; ?></td>
              <td><input type="text" name="flat" value="<?php echo $flat; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="ward" value="<?php echo $ward; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_shipping_date; ?></td>
              <td><input type="text" name="shipping_date" value="<?php echo $shipping_date; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_shipping_time; ?></td>
              <td><input type="text" name="shipping_time" value="<?php echo $shipping_time; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $text_remind; ?></td>
              <td><input type="checkbox" name="remind" value="1"<?php if($remind){ ?> checked="checked"<?php } ?> /></td>
            </tr>
            <tr>
              <td><?php echo $text_photo_free; ?></td>
              <td><input type="checkbox" name="photo_free" value="1"<?php if($photo_free){ ?> checked="checked"<?php } ?> /></td>
            </tr>
            <tr>
              <td><?php echo $text_photo_site; ?></td>
              <td><input type="checkbox" name="photo_site" value="1"<?php if($photo_site){ ?> checked="checked"<?php } ?> /></td>
            </tr>
            <tr>
        ...
        <div id="tab-product" class="vtabs-content">
            <?php if($postcard || $signature){ ?>
            <table class="form">
                <?php if($postcard){ ?>
                <tr>
                    <td><?php echo $text_postcard; ?></td>
                    <td><textarea name="postcard" cols="50" rows="5"><?php echo $postcard; ?></textarea></td>
                </tr>
                <?php } ?>
                <?php if($signature){ ?>
                <tr>
                    <td><?php echo $text_signature; ?></td>
                    <td><input type="text" value="<?php echo $signature; ?>" name="signature" style="width: 316px;" /></td>
                </tr>
                <?php } ?>
            </table>
            <?php } ?>
...
$('select[name="rt"]').change(function(){
    if($('select[name="rt"] option:selected').val() == 1){
        $('#rt_name,#rt_telephone').hide();
        $('#shipping_firstname').show();
    }else{
        $('#rt_name,#rt_telephone').show();
        $('#shipping_firstname').hide();
    }
});
//--></script> 
