  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs htabs2">
		...
		<a href="#tab-image">Image Gallery</a>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                <td><span class="required">*</span>Название:</td>
                <td><input type="text" name="post_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($post_description[$language['language_id']]) ? $post_description[$language['language_id']]['name'] : ''; ?>" />
              ...
              <tr>
                <td>Seo-Title:</td>
                <td><input type="text" name="post_description[<?php echo $language['language_id']; ?>][seo_title]" size="100" value="<?php echo isset($post_description[$language['language_id']]) ? $post_description[$language['language_id']]['seo_title'] : ''; ?>" />
                  <?php if (isset($error_name[$language['language_id']])) { ?>
                  <span class="error"><?php echo $error_name[$language['language_id']]; ?></span>
                  <?php } ?></td>
              </tr>
			  ...
			  <tr>
                ...
                <td><textarea name="post_description[<?php echo $language['language_id']; ?>][description]" id="description<?php echo $language['language_id']; ?>"><?php echo isset($post_description[$language['language_id']]) ? $post_description[$language['language_id']]['description'] : ''; ?></textarea>
        ...
        <div id="tab-data">
          <table class="form">
			<tr <?php echo ($is_admin_group == false)? 'style="display:none;"' : ''; ?>>
        ...
        <div id="tab-links">
          <table class="form">
            <tr>
              ...
              <td><div class="scrollbox">
                  ...
                  <div class="<?php echo $class; ?>">
                    ...
                    <input type="checkbox" name="post_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                    <?php echo $category['name']; ?>
                    <?php } else { ?>
                    <input type="checkbox" name="post_category[]" value="<?php echo $category['category_id']; ?>" />
                    <?php echo $category['name']; ?>
                    <?php } ?>
                  </div>
                  <?php } ?>
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div id="post-related" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($posts_related as $post_related) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="post-related<?php echo $post_related['post_id']; ?>" class="<?php echo $class; ?>"> <?php echo $post_related['name']; ?><img src="view/image/delete.png" />
          ...
          <table class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><select name="post_layout[<?php echo $store['store_id']; ?>][layout_id]">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
...
$('input[name=\'related\']').autocomplete({
	...
	select: function(event, ui) {
		$('#post-related' + ui.item.value).remove();
		
		$('#post-related').append('<div id="post-related' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" /><input type="hidden" name="post_related[]" value="' + ui.item.value + '" /></div>');

		$('#post-related div:odd').attr('class', 'odd');
		$('#post-related div:even').attr('class', 'even');
...
$('#post-related div img').live('click', function() {
	$(this).parent().remove();
