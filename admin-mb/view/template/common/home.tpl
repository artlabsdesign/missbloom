          ...
          <table class="list">
            <thead>
              <tr>
				...
				<td class="left">Дата | время доставки</td>
            ...
            <tbody>
              ...
              <tr>
                <td class="right orderId"><?php echo $order['order_id']; ?></td>
                <td class="left customer">
				<span class="name"><?php echo $order['customer']; ?></span><br />
				Тел:&nbsp;<?php echo $order['telephone']; ?><br />
				Email:&nbsp;<a href="mailto:<?php echo $order['email']; ?>?subject=Заказ №<?php echo $order['order_id']; ?>"><?php echo $order['email']; ?></a>
				</td>
				...
				foreach($order['products'] as $product) { 				
					...
					$popup = $this->model_tool_image->resize($product['image'], 650, 650);
					} else {
					$image = $this->model_tool_image->resize('no_image.jpg', 40, 40);
					$popup = $this->model_tool_image->resize('no_image.jpg', 650, 650);
				}
				?>
				<div class="orderProduct">
				<div style="float:left;"><a class="colorbox" title="<?php echo $product['name']; ?>" href="<?php echo $popup; ?>" ><img src="<?php echo $image; ?>"></a></div>
				...
				<?php }?>
				<?php if ($order['shipping_time']) { ?>
				&nbsp;|&nbsp;<?php echo $order['shipping_time']; ?>
				<?php }?>
				</td>
