...
class ModelSaleOrder extends Model {
	...
	public function editOrder($order_id, $data) {
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', payment_firstname = '" . $this->db->escape($data['payment_firstname']) . "', payment_lastname = '" . $this->db->escape($data['payment_lastname']) . "', payment_company = '" . $this->db->escape($data['payment_company']) . "', payment_company_id = '" . $this->db->escape($data['payment_company_id']) . "', payment_tax_id = '" . $this->db->escape($data['payment_tax_id']) . "', payment_address_1 = '" . $this->db->escape($data['payment_address_1']) . "', payment_address_2 = '" . $this->db->escape($data['payment_address_2']) . "', payment_city = '" . $this->db->escape($data['payment_city']) . "', payment_postcode = '" . $this->db->escape($data['payment_postcode']) . "', payment_country = '" . $this->db->escape($payment_country) . "', payment_country_id = '" . (int)$data['payment_country_id'] . "', payment_zone = '" . $this->db->escape($payment_zone) . "', payment_zone_id = '" . (int)$data['payment_zone_id'] . "', payment_address_format = '" . $this->db->escape($payment_address_format) . "', payment_method = '" . $this->db->escape($data['payment_method']) . "', payment_code = '" . $this->db->escape($data['payment_code']) . "', shipping_firstname = '" . $this->db->escape($data['shipping_firstname']) . "', shipping_lastname = '" . $this->db->escape($data['shipping_lastname']) . "',  shipping_company = '" . $this->db->escape($data['shipping_company']) . "', shipping_address_1 = '" . $this->db->escape($data['shipping_address_1']) . "', shipping_address_2 = '" . $this->db->escape($data['shipping_address_2']) . "', shipping_city = '" . $this->db->escape($data['shipping_city']) . "', shipping_postcode = '" . $this->db->escape($data['shipping_postcode']) . "', shipping_country = '" . $this->db->escape($shipping_country) . "', shipping_country_id = '" . (int)$data['shipping_country_id'] . "', shipping_zone = '" . $this->db->escape($shipping_zone) . "', shipping_zone_id = '" . (int)$data['shipping_zone_id'] . "', shipping_address_format = '" . $this->db->escape($shipping_address_format) . "', shipping_method = '" . $this->db->escape($data['shipping_method']) . "', shipping_code = '" . $this->db->escape($data['shipping_code']) . "', comment = '" . $this->db->escape($data['comment']) . "', order_status_id = '" . (int)$data['order_status_id'] . "', affiliate_id  = '" . (int)$data['affiliate_id'] . "', date_modified = NOW(), postcard = '" . $this->db->escape($data['postcard']) . "', signature = '" . $this->db->escape($data['signature']) . "', photo_free = '" . (int)$data['photo_free'] . "', photo_site = '" . (int)$data['photo_site'] . "', rt = '" . (int)$data['rt'] . "', rt_name = '" . $this->db->escape($data['rt_name']) . "', rt_telephone = '" . $this->db->escape($data['rt_telephone']) . "', rt_clarify = '" . (int)$data['rt_clarify'] . "', address_type = '" . (int)$data['address_type'] . "', street = '" . $this->db->escape($data['street']) . "', house = '" . $this->db->escape($data['house']) . "', building = '" . $this->db->escape($data['building']) . "', office = '" . $this->db->escape($data['office']) . "', flat = '" . $this->db->escape($data['flat']) . "', room = '" . $this->db->escape($data['room']) . "', ward = '" . $this->db->escape($data['ward']) . "', shipping_date = '" . $this->db->escape($data['shipping_date']) . "', shipping_time = '" . $this->db->escape($data['shipping_time']) . "', remind = '" . (int)$data['remind'] . "', order_status_sms = '" . (int)$data['order_status_sms'] . "', order_status_email = '" . (int)$data['order_status_email'] . "', newsletter = '" . (int)$data['newsletter'] . "' WHERE order_id = '" . (int)$order_id . "'");
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'postcard'           => $order_query->row['postcard'],
				'signature'           => $order_query->row['signature'],
				'photo_free'           => $order_query->row['photo_free'],
				'photo_site'           => $order_query->row['photo_site'],
				'rt'           => $order_query->row['rt'],
				'rt_name'           => $order_query->row['rt_name'],
				'rt_telephone'           => $order_query->row['rt_telephone'],
				'rt_clarify'           => $order_query->row['rt_clarify'],
				'address_type'           => $order_query->row['address_type'],
				'street'           => $order_query->row['street'],
				'house'           => $order_query->row['house'],
				'building'           => $order_query->row['building'],
				'office'           => $order_query->row['office'],
				'flat'           => $order_query->row['flat'],
				'room'           => $order_query->row['room'],
				'ward'           => $order_query->row['ward'],
				'shipping_date'           => $order_query->row['shipping_date'],
				'shipping_time'           => $order_query->row['shipping_time'],
				'remind'           => $order_query->row['remind'],
				'order_status_sms'           => $order_query->row['order_status_sms'],
				'order_status_email'           => $order_query->row['order_status_email'],
				'newsletter'           => $order_query->row['newsletter'],
			);
		} else {
			return false;
		}
