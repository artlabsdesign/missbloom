...
<meta name="google-site-verification" content="Xv2YbDUmc7JHpD3--J8edWX3AM-S5DUIgGYyi57-IrY"/>
...
<!-- MMENU -->
<script src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/js/mmenu/dist/js/jquery.mmenu.min.js" type="text/javascript"></script>
<script src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/js/mmenu/dist/js/addons/jquery.mmenu.fixedelements.min.js" type="text/javascript"></script>
<link href="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/js/mmenu/dist/css/jquery.mmenu.css" rel="stylesheet"/>
<!-- END MMENU -->
...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/stylesheet/ultimatum_theme_custom2.css" />
<script type="text/javascript" src="catalog/view/javascript/jquery/tabs.js"></script>

<!-- CALLBACKHUNTER -->
<!-- <link rel="stylesheet" href="//cdn.callbackhunter.com/widget/tracker.css"> 
<script type="text/javascript" src="//cdn.callbackhunter.com/widget/tracker.js" charset="UTF-8"></script> 
<script type="text/javascript">var hunter_code="9cdbe384b29805626fc51dd1a14b42df";</script><? /* $test = '10b500f412699c29dc479d68bf4babcc'; $prod = '9cdbe384b29805626fc51dd1a14b42df'; */ ?>
-->
...
$(document).ready(function(){
    $('.testing_div').iftheycall('get_code', {
        ...
        token: 'c0ddbd8811a8770ac154f77ef3eaa64c'
    });
});
</script>
...
<div id="header_wrapper">
  <div id="header_all">
    <div id="header_top" class="Fixed">
      <div class="inner">
        ...
        <div class="header_support">
		 <span class="workTime2">Ежедневно: с 10 до 20:00</span>  
		...
		<?php echo $text_header_support; ?>
		  ...
		  <span class="workTime"><i class="icon-skype"></i><a class="skype_link" href="skype:missbloom.shop?call">missbloom.shop</a></span>
          <?php if($this->config->get('ULTIMATUMControl_header_support_phone') != null) { ?>
          <span class="hphone"><?php echo $this->config->get('ULTIMATUMControl_header_support_phone'); ?></span>
          <?php } ?>
			<span id="callbackLink"><i class="icon-phone"></i><a href="#" class = "" >Обратный звонок</a></span>
	    </div>
    ...
    <div id="header_colapse" class="Fixed">
      <div id="togglerone" class="inner">
	 <div id="my_slidemenu1_button"><a href="#menu_mobile">
			<div class="my_button-search"><i class = "icon-menu"></i></div></a>
			</div>
		
	<div id="my_info_button">
			<div class="my_button-info"><i class = "icon-myinfo"></i></div>
			</div>		
        <div id="search">
        ...
        <div id="cur_lang">
          <div class="links">
            <ul id="main_nav">
				<li class="desktop-menu-item"><a href="/about-us">О компании</a></li>
				<li class="desktop-menu-item"><a href="/dostavka">Оплата/доставка</a></li>
				<li class="desktop-menu-item"><a href="/special">Акции и скидки</a></li>
              <?php  if($this->config->get('ULTIMATUMControl_blog_link') == '1'){ ?>
              <li><a href="<?php echo $blog_link_header; ?>" class="blog_link"><i class="desktop-menu-item-hide icon-book"></i> <?php echo $text_blog; ?></a></li>
              <?php } ?>
              <?php if(($this->config->get('ULTIMATUMControl_information_link') == '1') && ($informations)) { ?>
              <li class="subico"><a href="#" class="information_link"><i class="desktop-menu-item-hide  icon-question-sign"></i> <?php echo $text_information; ?></a>
                <ul class="secondary">
  ...
  <?php } ?>
              ...
              <?php } ?>
              <?php } ?>
              <li class="contact_header"><a href="<?php echo $contact; ?>"><i class="desktop-menu-item-hide icon-envelope"></i> <?php echo $text_contact; ?></a></li>
      ...
      <div class="inner main_head_inner">
		...
		<ul>
          ...
          <ul>
            ...
            <li><a href="<?php echo $child['href']; ?>" class="mobile_sub"><?php echo $child['name']; ?></a></li>
          ...
          <li><a href="<?php echo $brand; ?>"><?php echo $text_brands; ?></a></li>
          <?php } ?>
