...
<?php echo $content_top; ?>
  ...
  <h2><span><?php echo $text_search; ?></span></h2>
  <?php if ($products) { ?>
        ...
        ?>
            ...
            <div class="price">
              ...
              <div class="count_holder_small">
                ...
                <div id="ULTIMATUMCountSmallsearch<?php echo $product['product_id']; ?>"></div>
                <script type="text/javascript">
					$(function () {	
						$('#ULTIMATUMCountSmallsearch<?php echo $product['product_id']; ?>').countdown({until: new Date(<?php echo $product['date_end']; ?>), compact: false, layout: '<span class="countdown_time_small">{dn} {dl} {hn}:{mnn}:{snn}</span>'});
					});
		</script>
                <div class="clear"></div>
              </div>
