<script type="text/javascript">
  ...
  function initialize() {
    ...
    var latlng = new google.maps.LatLng(<?php echo $this->config->get('ULTIMATUMControl_latitude') ?>,<?php echo $this->config->get('ULTIMATUMControl_longitude') ?>);
	...
	// Here you can change the path, size and pivot point of the marker on the map.
   	var image = new google.maps.MarkerImage('catalog/view/theme/ULTIMATUM/image/google_maps/marker.png',
    ...
    var shadow = new google.maps.MarkerImage('catalog/view/theme/ULTIMATUM/image/google_maps/shadow.png',
  ...
  function calcRoute() {
	...
	var end = "<?php echo $this->config->get('ULTIMATUMControl_latitude') ?>,<?php echo $this->config->get('ULTIMATUMControl_longitude') ?>";
    var request = {
      origin:start,
      destination:end,
