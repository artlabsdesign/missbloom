<?php if($this->config->get('ULTIMATUMControl_bestseller_video') != null) { ?>
<?php $parClass = "box-paralax"; ?>
<script type="text/javascript">
$(document).ready(function(){
	$("html.no-touch #bestsellerVideo<?php echo $module; ?>").mb_YTPlayer();
})
</script>
<?php } ?>
<?php
...
?>
<?php if(($this->config->get('ULTIMATUMControl_bestsellersBg1Img') || $this->config->get('ULTIMATUMControl_bestsellersBg2Img') != null && $this->config->get('ULTIMATUMControl_deal_video') == null) && ($this->config->get('ULTIMATUMControl_status') == '1') && ($setting['position'] == 'content_top_fullwidth') || ($setting['position'] == 'content_bottom_fullwidth')) { ?>
<?php $parClass = "box-paralax"; ?>
<script type="text/javascript">
$(document).ready(function(){	
	$('html.no-touch .box-bestsellers').parallax("50%", 0.1, true);
})
</script>
<?php } else { ?>
...
<div class="box box-bestsellers <?php echo $parClass; ?>">
  <div class="bg">
  
    <?php if((($this->config->get('ULTIMATUMControl_bestseller_video') != null) && ($setting['position'] == 'content_top_fullwidth')) || (($this->config->get('ULTIMATUMControl_bestseller_video') != null) && ($setting['position'] == 'content_bottom_fullwidth'))) { ?>
<div class="pattern"></div>
<a id="bestsellerVideo<?php echo $module; ?>" class="domplayer" data-property="{videoURL:'<?php echo $this->config->get('ULTIMATUMControl_bestseller_video'); ?>',containment:'.box-bestsellers .bg', showControls:false, autoPlay:true, loop:true, mute:true, startAt:<?php echo $this->config->get('ULTIMATUMControl_bestseller_video_start'); ?>, opacity:1, addRaster:true, quality:'default'}">My video</a>
<?php } ?>
  ...
  <div class="inner">
    ...
    <div class="box-content">
      <div class="box-product" id="bestsellers_module<?php echo $module; ?>">
        ...
        <div class="prod_hold">
          ...
          <?php if (($product['thumb_2']) && ($this->config->get('ULTIMATUMControl_status') == '1') && ($this->config->get('ULTIMATUMControl_bestseller_hover_mode') == '1')) { ?>
        ...
        ?>
            ...
            <div class="price">
              ...
              <div class="count_holder_small">
                ...
                <div id="ULTIMATUMCountSmallbestsellers<?php echo $product['product_id']; ?>"></div>
                <script type="text/javascript">
					$(function () {	
						$('#ULTIMATUMCountSmallbestsellers<?php echo $product['product_id']; ?>').countdown({until: new Date(<?php echo $product['date_end']; ?>), compact: false, layout: '<span class="countdown_time_small">{dn} {dl} {hn}:{mnn}:{snn}</span>'});
					});
		</script>
                <div class="clear"></div>
              </div>
            ...
            <?php if($this->config->get('ULTIMATUMControl_bestseller_flydesc_mode') == '1'){ ?>
          <div class="flydesc"><?php echo $product['description']; ?></div>
          <script type="text/javascript">
          $(function() {

    	$('html.no-touch .box-bestsellers div.prod_hold').each(function() {        
      ...
      <?php if(($this->config->get('ULTIMATUMControl_status') == '1') && ($this->config->get('ULTIMATUMControl_bestseller_mode') == 'bestseller_carousel')){ ?>
      <script type="text/javascript">
    $(document).ready(function() {
  ...
  var myNumber3 = 3;
    ...
    var owl = $("#bestsellers_module<?php echo $module; ?>");
