      ...
      <form id="dsl_email_form">
        ...
        <?php } ?>
          <?php foreach($fields as $field){ ?>
            ...
            <?php }else{ ?>
              <input type="<?php echo $field['type']; ?>" id="<?php echo $field['id']; ?>" name="<?php echo $field['id']; ?>" value="<?php echo (isset($profile_value[$field['id']])) ? $profile_value[$field['id']] : ''; ?>" placeholder="<?php echo ${'text_'.$field['id']}; ?>"/>
             <?php } ?>
           </div>
        ...
        <?php } ?> 
        <div>
          <?php if($profile['photoURL']){ ?><img src="<?php echo $profile['photoURL']; ?>" id="dsl_profile_image" /><?php } ?><a id="dsl_email_submit" class="button"><?php echo $button_sign_in; ?></a>
        </div>
      </form>
    </div>
  </div>
