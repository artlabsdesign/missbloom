    ...
    <form action="">
      ...
      <?php } ?>
            ...
            <?php } elseif ($option['type'] == 'slide' || $option['type'] == 'slide_dual') { # Slide type start ?>
	          ...
	          <?php $myidnumber=1; foreach ($option['values'] as $key => $value) { ?>
	            ...
	            <?php if ($option['image']) { ?>
							...
							<?php if ($value['selected']) { ?>
		          <input id="<?php echo 'my_chbid_'. $myidnumber;?>" type="<?php echo $option['type']; ?>" name="option[<?php echo $option['option_id']; ?>]" value="<?php echo $value['params']; ?>" checked="checked" class="ocf-target" hidden />
				  <label for="<?php echo 'my_chbid_'. $myidnumber;?>" id="v-<?php echo $value['id']; ?>" class="selected"><?php echo $value['name']; ?><?php if ($show_counter) { ?><small></small><?php } ?></label>
							<?php } elseif ($value['count']) { ?>
		          <input id="<?php echo 'my_chbid_'. $myidnumber;?>" type="<?php echo $option['type']; ?>" name="option[<?php echo $option['option_id']; ?>]" value="<?php echo $value['params']; ?>" class="ocf-target" hidden />
				  <label for="<?php echo 'my_chbid_'. $myidnumber;?>" id="v-<?php echo $value['id']; ?>"><?php echo $value['name']; ?><?php if ($show_counter) { ?><small><?php echo $value['count']; ?></small><?php } ?></label>
							<?php } else { ?>
		          <input id="<?php echo 'my_chbid_'. $myidnumber;?>" type="<?php echo $option['type']; ?>" name="option[<?php echo $option['option_id']; ?>]" value="<?php echo $value['params']; ?>" disabled="disabled" class="ocf-target" hidden />
				  <label for="<?php echo 'my_chbid_'. $myidnumber;?>" id="v-<?php echo $value['id']; ?>" class="disabled"><?php echo $value['name']; ?><?php if ($show_counter) { ?><small>0</small><?php } ?></label>
		          <?php }  ?>
				  <?php ++$myidnumber;  ?>
