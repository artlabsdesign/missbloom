<div id="ajaxcartmodal">
    <?php if (!empty($products)) { ?>
	    ...
	    <br /><br />
	    <img src="image/ajaxcart/loading.gif" id="ajaxcartloadimg"/>
        	...
        	<div class="ajaxtable_tbody">
            	...
            	<div id="pid-<?=$product['key'] ?>" class="ajaxtable_tr">
		    		...
		    		<div class="ajaxtable_td delete">
						<input hidden class="product_id" value="<?=$product['key']; ?>" style="display:none;"/>
		                <a onclick="del(this);" style="text-align:center;margin:0 auto;"><img src="catalog/view/theme/default/image/remove-small.png" alt="Удалить" title="Удалить" class="del" /></a>
		            </div>
    			</div> 
	          	<?php } ?>
      		</div>
    ...
    <div class="ajaxcartbtns">
    	<a onclick="$.colorbox.close();" class="button" id="gotoshopping"><?php echo $text_gotoshipping; ?></a>
    	<a href="<?php echo $checkout; ?>" class="button" id="gotoorder"><?php echo $text_gotoorder; ?></a>
    </div>
	...
	<div class="carousel-ajcart"> 
		<div class="carousel-button-left-ajcart"><a href="javascript:void(0);"><img src="image/ajaxcart/carousel-left.png"/></a></div> 
		<div class="carousel-button-right-ajcart"><a href="javascript:void(0);"><img src="image/ajaxcart/carousel-right.png"/></a></div> 
...
function plus(id){
	...
	$.ajax({
		url: 'index.php?route=common/ajaxcart&update='+pid+'&qty='+quantity,
		type: 'post',
		dataType: 'html',
		success:function(data) {	
	        $.colorbox({
		       	href:'index.php?route=common/ajaxcart',
