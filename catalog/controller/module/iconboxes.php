...
class ControllerModuleiconboxes extends Controller {
	protected function index($setting) {
		...
		$this->language->load('module/iconboxes');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/iconboxes.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/iconboxes.tpl';
		} else {
			$this->template = 'default/template/module/iconboxes.tpl';
		}
