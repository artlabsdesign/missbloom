...
class ControllerProductsendcustomertestimonial extends Controller {
	private $error = array(); 
	...
	protected function str_split_unicode($str, $l = 0) {
  	...
  	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validate()) {
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('product/sendcustomertestimonial', '', 'SSL'),
  	...
  	public function success() {
		...
		$this->document->SetTitle($this->language->get('isi_customertestimonial')); 
