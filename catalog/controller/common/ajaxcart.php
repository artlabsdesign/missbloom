...
class ControllerCommonajaxcart extends Controller {

    private $_path = HTTPS_SERVER;
    private $_name = 'ajaxcart';

    public function index() {
        $this->language->load('module/ajaxcart');
...
// Gift Voucher
        ...
        $this->template = 'default/template/common/ajaxcart.tpl';
