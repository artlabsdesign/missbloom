<?php
class ControllerCheckoutajaxcheckout extends Controller {
    ...
    public function index() {
        ...
        $this->language->load('checkout/ajaxcheckout');
        $this->load->model('catalog/product');

        $this->data['text_ajaxcheckout_errorname'] = $this->language->get('text_ajaxcheckout_errorname');
        $this->data['text_ajaxcheckout_errortelephone'] = $this->language->get('text_ajaxcheckout_errortelephone');
        $this->data['text_ajaxcheckout_erroremail'] = $this->language->get('text_ajaxcheckout_erroremail');

        $this->data['text_ajaxcheckout_head'] = $this->language->get('text_ajaxcheckout_head');
        $this->data['text_ajaxcheckout_success'] = $this->language->get('text_ajaxcheckout_success');
        $this->data['text_ajaxcheckout_selectshipping'] = $this->language->get('text_ajaxcheckout_selectshipping');
        $this->data['text_ajaxcheckout_selectpayment'] = $this->language->get('text_ajaxcheckout_selectpayment');
        $this->data['text_ajaxcheckout_cancel'] = $this->language->get('text_ajaxcheckout_cancel');
        $this->data['text_ajaxcheckout_ordernow'] = $this->language->get('text_ajaxcheckout_ordernow');
        $this->data['text_ajaxcheckout_entername'] = $this->language->get('text_ajaxcheckout_entername');
        $this->data['text_ajaxcheckout_entertelephone'] = $this->language->get('text_ajaxcheckout_entertelephone');
        $this->data['text_ajaxcheckout_enteremail'] = $this->language->get('text_ajaxcheckout_enteremail');
        $this->data['text_ajaxcheckout_enterdescription'] = $this->language->get('text_ajaxcheckout_enterdescription');
        $this->data['text_ajaxcheckout_ibuy'] = $this->language->get('text_ajaxcheckout_ibuy');
        $this->data['text_ajaxcheckout_priceof'] = $this->language->get('text_ajaxcheckout_priceof');
        $this->data['text_ajaxcheckout_inanamount'] = $this->language->get('text_ajaxcheckout_inanamount');
        $this->data['text_ajaxcheckout_selectoption'] = $this->language->get('text_ajaxcheckout_selectoption');
        $this->data['text_ajaxcheckout_loading'] = $this->language->get('text_ajaxcheckout_loading');
        ...
        $this->template = 'default/template/checkout/ajaxcheckout.tpl';
    ...
    public function simpleorder() {
        ...
        $product['tax'] = $this->tax->getTax($product_info['price'], $product_info['tax_class_id']);
        ...
        if ($this->config->get('config_type_hidefio') == 1) {
            if ($this->config->get('config_required_fio') == 1) {
                if ($firstname == null || $firstname == '') {
                    $json['error']['firstname'] = $this->data['text_ajaxcheckout_errorname'];
                }
            }
        }
        ...
        if ($this->config->get('config_type_hideemail') == 1) {
            if ($this->config->get('config_required_email') == 1) {
                ...
                if ($orderemail == null || $orderemail == '' || $validemail == FALSE) {
                    $json['error']['email'] = $this->data['text_ajaxcheckout_erroremail'];
                }
            }
        }
        ...
        if ($this->config->get('config_type_hidetelephone') == 1) {
            if ($this->config->get('config_required_telephone') == 1) {
                if ($telephone == null || $telephone == '') {
                    $json['error']['telephone'] =  $this->data['text_ajaxcheckout_errortelephone'];
                }
            }
        }
        ...
        $this->data['text_ajaxcheckout_success'] = $this->language->get('text_ajaxcheckout_success');
        $this->data['text_ajaxcheckout_error'] = $this->language->get('text_ajaxcheckout_error');
        $this->data['text_ajaxcheckout_continue'] = $this->language->get('text_ajaxcheckout_continue');
        ...
        $json['output'] = '<h1>'.$this->data['text_ajaxcheckout_success'].'</h1><p>'.$this->language->get('text_ajaxcheckout_success_text').'</p>'.'<a onclick="$.colorbox.close();" class="button">'.$this->data['text_ajaxcheckout_continue'].'</a>';
