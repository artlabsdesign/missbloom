...
class ControllerAccountRegister extends Controller {
    ...
    public function fast(){
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateFast()) {            
            $passwrod = $this->model_account_customer->addCustomerFast($this->request->post);
            $this->customer->login($this->request->post['email'], $passwrod);
        }else {
            if (isset($this->error['warning'])) {
                $json['errors']['error_warning'] = $this->error['warning'];
            }

            if (isset($this->error['firstname'])) {
                $json['errors']['error_firstname'] = $this->error['firstname'];
            }

            if (isset($this->error['lastname'])) {
                $json['errors']['error_lastname'] = $this->error['lastname'];
            }

            if (isset($this->error['email'])) {
                $json['errors']['error_email'] = $this->error['email'];
            }

            if (isset($this->error['telephone'])) {
                $json['errors']['error_telephone'] = $this->error['telephone'];
            }
